...
write.table(PRS.INDELS, "Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/prs/OLD_Indels_PRS.bed", row.names = F, col.names = F, quote = F, sep = "\t")
write.table(PRS.SNVS, "Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/prs/OLD_SNVs_PRS.bed", row.names = F, col.names = F, quote = F, sep = "\t")
write.table(all.cancers, "Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/prs/OLD_ALL_Cancers_PRS_data.txt", row.names = F, col.names = T, quote = F, sep = "\t")
