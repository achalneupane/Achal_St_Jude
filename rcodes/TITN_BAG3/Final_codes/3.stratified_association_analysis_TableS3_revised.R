...
## African ancestry ##
######################
pheno_final <- read.table("Z:/ResearchHome/Groups/sapkogrp/projects/Cardiotoxicity/common/ttn_bag3/pheno/sjlife_ttn_bag3_afr.pheno", header = T)
geno <- read.table("Z:/ResearchHome/Groups/sapkogrp/projects/Cardiotoxicity/common/ttn_bag3/sjlife_afr_to_concat_updated_ttn_bag3_top_snps_add.raw", header = T)
...
print(table_data)
# Group  Estimate Std_Error  Z_Value   P_Value        n Odds_Ratio  CI_Lower CI_Upper
# 1   All 0.4410037 0.3281629 1.343856 0.1789949 246 (40)   1.554266 0.8169352 2.957082
