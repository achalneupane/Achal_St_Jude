...
###########################################
## Annotate 9 genes only with gnomAD 4.1 ##
###########################################
cd /research_jude/rgs01_jude/groups/sapkogrp/projects/Cardiotoxicity/common/ttn_bag3/rare_variant_sjlife_ccss_combined
# Input VCF file
...
for CHR in 1 2 3 6 10 14 17; do
    ...
    GNOMAD_VCF="/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/sjlife/MERGED_SJLIFE_1_2/annotation/snpEff/data/gnomAD/genome_4.1/gnomad.genomes.v4.1.sites.chr${CHR}.vcf.bgz"
