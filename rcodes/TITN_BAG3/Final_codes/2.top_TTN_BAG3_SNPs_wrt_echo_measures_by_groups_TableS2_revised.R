...
load("Z:/ResearchHome/Groups/sapkogrp/projects/Cardiotoxicity/common/ttn_bag3/Rcodes/echo.PLP.eur.RData")
echo.PLP.eur.baseline <- echo.PLP.eur[echo.PLP.eur$visittype == "SJLIFE Visit 1",]

dat_final <- echo.PLP.eur.baseline
## Analyze both variants wrt each echo measures
# BAG3 SNP
res_bag3 = NULL
echo_phenotypes = colnames(dat_final)[grepl("LV", colnames(dat_final))]
