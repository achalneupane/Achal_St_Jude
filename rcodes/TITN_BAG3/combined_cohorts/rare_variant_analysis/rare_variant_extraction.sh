...
plink --bfile sjlife_ccss_exp_merged_maxmaf_0.01 --freq --out sjlife_ccss_exp_merged_maxmaf_0.01.frqout
...
# subset to SJLIFE and CCSS_Exp EUR cohort
plink --bfile merged_plink_PLP --keep sjlife_ccss_exp_samples.txt --max-maf 0.01 --make-bed --keep-allele-order --out sjlife_ccss_exp_merged_maxmaf_0.01_EUR
plink --bfile merged_plink_PLP --keep ../afr_samples --max-maf 0.01 --make-bed --keep-allele-order --out sjlife_ccss_exp_merged_maxmaf_0.01_AFR
# plink --bfile merged_plink_PLP --keep sjlife_ccss_exp_samples.txt --max-maf 0.001 --make-bed --keep-allele-order --out sjlife_ccss_exp_merged_maxmaf_0.001
# plink --bfile sjlife_ccss_exp_merged_maxmaf_0.01 --freq --out sjlife_ccss_exp_merged_maxmaf_0.01.frqout
...
## Run 0.Annotation_v2.R code to get the list of variants for analysis
plink --bfile sjlife_ccss_exp_merged_maxmaf_0.01_EUR --extract snpEFF_AF_nfe_0.01_vars.txt --geno 0.01 --recodeA --out sjlife_ccss_exp_SNPS_maf_lt_0.01_gnomad_recodeA_EUR
plink --bfile sjlife_ccss_exp_merged_maxmaf_0.01_AFR --extract snpEFF_AF_afr_0.01_vars.txt --geno 0.01 --recodeA --out sjlife_ccss_exp_SNPS_maf_lt_0.01_gnomad_recodeA_AFR
