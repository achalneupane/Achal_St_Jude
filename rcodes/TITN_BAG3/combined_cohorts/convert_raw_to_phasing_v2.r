...
write(first, file="haplotype_input_edited_0.2.txt", append = T)
write(second, file="haplotype_input_edited_0.2.txt", append = T)
write(paste0(third, collapse = " "), file="haplotype_input_edited_0.2.txt", append = T)
write(fourth, file="haplotype_input_edited_0.2.txt", append = T)


for (i in 1:nrow(raw)){
print(paste0("Doing row: ", i))  
sample <- paste0("#", rownames(raw)[i])
write(sample, file="haplotype_input_edited_0.2.txt", append = T)
...
write(line1, file="haplotype_input_edited_0.2.txt", append = T)
write(line2, file="haplotype_input_edited_0.2.txt", append = T)
}
