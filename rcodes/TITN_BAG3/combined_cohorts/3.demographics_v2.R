...
# PHENO-name = CMP
sjlife.to.concat <- rbind.data.frame(sjlife.to.concat.1, sjlife.to.concat.0)
# sjlife.to.concat$CMP2plus <- sjlife.to.concat$CMP
# sjlife.to.concat$a_dx <- sjlife.to.concat$agedx
# sjlife.to.concat$a_end <- sjlife.to.concat$agelstcontact
# sjlife.to.concat$SEX <- sjlife.to.concat$gender
# sjlife.to.concat$anth_DED <- sjlife.to.concat$anthra_jco_dose_any
# sjlife.to.concat$HeartAvg <- sjlife.to.concat$hrtavg

# MAKE SJLIFE colnames same as CCSS
sjlife.to.concat <- sjlife.to.concat[c("FID", "IID", "CMP", "agedx", "agelstcontact", "gender", "anthra_jco_dose_any", "hrtavg", "agevent", 
                   "ejection_fraction_hrt", "PC1", "PC2", "PC3", "PC4", "PC5", "PC6", "PC7", "PC8", "PC9", "PC10")]


dim(ccss_org.to.concat.1)
dim(ccss_org.to.concat.0)
# a_dx,a_end,SEX,anth_DED,HeartAvg,PC1,PC2,PC3,PC4,PC5,PC6,PC7,PC8,PC9,PC10
# PHENO-name = CMP2plus

ccss_org.to.concat <- rbind.data.frame(ccss_org.to.concat.1, ccss_org.to.concat.0)
ccss_org.to.concat$ejection_fraction_hrt <- NA
## Extract only the required columns
ccss_org.to.concat <- ccss_org.to.concat[c("FID", "IID", "CMP", "agedx", "agelstcontact", "gender", "anthra_jco_dose_any", "hrtavg", "agevent",
                   "ejection_fraction_hrt", "PC1", "PC2", "PC3", "PC4", "PC5", "PC6", "PC7", "PC8", "PC9", "PC10")]

dim(ccss_exp.to.concat.1)
dim(ccss_exp.to.concat.0)
# a_dx,a_end,SEX,anth_DED,HeartAvg,PC1,PC2,PC3,PC4,PC5,PC6,PC7,PC8,PC9,PC10
# PHENO-name = CMP2plus
ccss_exp.to.concat <- rbind.data.frame(ccss_exp.to.concat.1, ccss_exp.to.concat.0)
ccss_exp.to.concat$ejection_fraction_hrt <- NA
## Extract only the required columns
ccss_exp.to.concat <- ccss_exp.to.concat[c("FID", "IID", "CMP", "agedx", "agelstcontact", "gender", "anthra_jco_dose_any", "hrtavg", "agevent",
                     "ejection_fraction_hrt", "PC1", "PC2", "PC3", "PC4", "PC5", "PC6", "PC7", "PC8", "PC9", "PC10")]
