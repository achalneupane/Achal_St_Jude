---
title: "Additional analysis for LVNC project (Cardiomyocytes)"
...
## 1. LVNC vs Control (cardiomyocytes)

```{r, eval=TRUE, echo= TRUE}
## only cardiomyocyte
properties <- properties.save[properties.save$Cell_Type == "Cardiomyocytes",]
...
tiff(file="Heatmap_top_500_genes_LVNC_Control_Cardiomyocytes.tiff",width = 18, height = 32, units = 'cm', res = 300, compression = 'lzw')
phm
dev.off()
```
...
write.table(deseq_results, file="deseq_results_LVNC_vs_Control_Cardiomyocytes.txt", sep="\t")
...
tiff(file="Volcano_plot_LVNC_vs_Control_Cardiomyocytes.tiff",
...
## 2. HCM vs Control (cardiomyocytes)
...
myMatrixforheatmap<-myMatrix[topVarGenes,]
phm<-pheatmap(myMatrixforheatmap, scale="row", cluster_rows = TRUE, cluster_cols = TRUE, annotation_col = properties2, show_colnames = TRUE, show_rownames = FALSE)
tiff(file="Heatmap_top_500_genes_HCM_Control_Cardiomyocytes.tiff",width = 18, height = 32, units = 'cm', res = 300, compression = 'lzw')
phm
dev.off()
```
...
write.table(deseq_results, file="deseq_results_HCM_vs_Control_Cardiomyocytes.txt", sep="\t")
...
tiff(file="Volcano_plot_HCM_vs_Control_Cardiomyocytes.tiff",
     width = 18, height = 16, units = 'cm', res = 300, compression = 'lzw')
p
dev.off()
```
...
## 3. DCM vs Control (cardiomyocytes)
...
myMatrixforheatmap<-myMatrix[topVarGenes,]
phm<-pheatmap(myMatrixforheatmap, scale="row", cluster_rows = TRUE, cluster_cols = TRUE, annotation_col = properties2, show_colnames = TRUE, show_rownames = FALSE)
tiff(file="Heatmap_top_500_genes_DCM_Control_Cardiomyocytes.tiff",width = 18, height = 32, units = 'cm', res = 300, compression = 'lzw')
phm
dev.off()
```
...
write.table(deseq_results, file="deseq_results_DCM_vs_Control_Cardiomyocytes.txt", sep="\t")
...
tiff(file="Volcano_plot_DCM_vs_Control_Cardiomyocytes.tiff",
     width = 18, height = 16, units = 'cm', res = 300, compression = 'lzw')
p
dev.off()
```
