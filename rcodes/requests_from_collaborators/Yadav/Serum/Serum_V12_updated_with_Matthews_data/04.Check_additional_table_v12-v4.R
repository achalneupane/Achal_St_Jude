...
all.wanted.df.1200.to.update <- read.table("Z:/ResearchHome/ClusterHome/aneupane/data/Yadav_serum/v12_output/plasma_data_batch1_1200_samples_v4_updated.txt", header = T, sep = "\t")
...
## saveRDS(CTCAE.2, "Z:/ResearchHome/ClusterHome/aneupane/data/Yadav_serum/v12_output/ge.grade2.baseline.rds")
CTCAE.2 <- readRDS("Z:/ResearchHome/ClusterHome/aneupane/data/Yadav_serum/v12_output/ge.grade2.baseline.rds")
...
write.table(all.wanted.df.1200.to.update, "Z:/ResearchHome/ClusterHome/aneupane/data/Yadav_serum/v12_output/plasma.df.1200.with_additional_variables_toYadav.txt", col.names = T, row.names = F, sep = "\t", quote = F)
