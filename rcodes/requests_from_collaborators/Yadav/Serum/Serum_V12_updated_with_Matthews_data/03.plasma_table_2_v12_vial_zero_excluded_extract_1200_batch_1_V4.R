...
## These are eligible but not treated with anthracyclines; remove them
...
HL.260.zhaoming <- read.table("Z:/ResearchHome/ClusterHome/aneupane/data/Yadav_serum/v12_output/HL.selected.210_plus_50.txt", header = F)
table(HL.260.zhaoming$V1 %in% all.hodgkin$sjlid)
# FALSE  TRUE 
# 31   229  
all.hodgkin.extract <- all.hodgkin[all.hodgkin$sjlid %in% HL.260.zhaoming$V1,]

set.seed(54321)
# select 200
all.hodgkin.extract.samples <- sample(unique(all.hodgkin.extract$sjlid), 200)
all.hodgkin.extract <- all.hodgkin[all.hodgkin$sjlid %in% all.hodgkin.extract.samples,]
...
write.table(all.wanted.df.1200, "Z:/ResearchHome/ClusterHome/aneupane/data/Yadav_serum/v12_output/plasma_data_batch1_1200_samples_v4.txt", col.names = T, row.names = F, quote = F, sep = "\t", na="")
...
all.wanted.df.1200.to.update <- read.table("Z:/ResearchHome/ClusterHome/aneupane/data/Yadav_serum/v12_output/plasma_data_batch1_1200_samples_v4.txt", header = T, sep = "\t")
...
write.table(all.wanted.df.1200.to.update, "Z:/ResearchHome/ClusterHome/aneupane/data/Yadav_serum/v12_output/plasma_data_batch1_1200_samples_v4_updated.txt", col.names = T, row.names = F, quote = F, sep = "\t", na="")
...
#############################
write.table(all.wanted.df.1200.to.update.proteomics, "Z:/ResearchHome/ClusterHome/aneupane/data/Yadav_serum/v12_output/plasma_data_batch1_1200_samples_to_proteomics_core_v4.txt", col.names = T, row.names = F, sep = "\t", quote = F)
...
write.table(all.wanted.df.1200.to.update.kyla, "Z:/ResearchHome/ClusterHome/aneupane/data/Yadav_serum/v12_output/plasma_data_batch1_1200_samples_to_ECC_v4.txt", col.names = T, row.names = F, sep = "\t", quote = F)
...
write.table(all.wanted.df.1200.to.update.kyla, "Z:/ResearchHome/ClusterHome/aneupane/data/Yadav_serum/v12_output/plasma_data_batch1_1200_samples_to_ECC_with_vials_info_v4.txt", col.names = T, row.names = F, sep = "\t", quote = F)
