metabol <- read.delim("Z:/ResearchHome/Groups/sapkogrp/projects/CAB/common/metabolomics_Northwestern/Report-Bur-Dis-20231206-CHMP_edited.txt", header = T, sep = "\t", stringsAsFactors = F)
colnames(metabol) <- gsub("^0","",gsub("Bur.Dis.Gra.20231206.", "", colnames(metabol)))
colnames(metabol) <-
