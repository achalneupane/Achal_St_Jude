...
dds <- DESeqDataSetFromMatrix(countData = counts.matrix_ROBI,colData = properties, design=~1)
...
form <- ~ Group + (1 | Cell_type)

## metadata
info <-  properties2[, c("Group", "Cell_type")]

# fit model and extract variance percents
varPart <- fitExtractVarPartModel(quantLog, form, info, showWarnings = FALSE)
head(varPart)
# violin plot
