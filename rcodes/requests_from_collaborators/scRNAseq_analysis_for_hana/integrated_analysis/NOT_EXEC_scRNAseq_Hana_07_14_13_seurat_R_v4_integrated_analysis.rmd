...
# Analysis for Q1: The first question is to see differences between control and cardiomyopathy group.
...
top.markers <- ReadObject("seurat_obj_top_markers")
top.markers.df <- ReadObject("seurat_obj_top_markers_dataframe_list")
...
# ReadObject("trt_control.DGE")
write.table(trt_control.markers, "cardiomyopathy_Vs_control_DGE_in_cardiomyocyte_cluster.txt", col.names = T, row.names = T, quote = F)
```
