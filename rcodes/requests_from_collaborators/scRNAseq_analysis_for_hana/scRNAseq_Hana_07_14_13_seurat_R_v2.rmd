...
pbmc_markers_trt_control <- FindMarkers(pbmc.tmp, ident.1 = "control", ident.2 = "cardiomyopathy", min.pct = 0.25, logfc.threshold = 0.25)
pbmc_markers_trt_control %>% group_by(cluster) %>% top_n(n = 2, wt = avg_log2FC)
...
```{r, echo=TRUE}
FeaturePlot(pbmc, features = c("IGF2", "LINC02899", "COL1A1"), split.by = "grouping_var1", max.cutoff = 3,
    cols = c("grey", "red"))
```
