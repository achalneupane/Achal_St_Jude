...
workdir <- "Z:/ResearchHome/Groups/sapkogrp/projects//Cardiotoxicity/common/gwas/rare_variants/geneBased_June_24_2024/EUR/"
# workdir<-args[1]
...
covarsfile <- "Z:/ResearchHome/Groups/sapkogrp/projects//Cardiotoxicity/common/gwas/pheno/sjlife_eur_dox_only_pcs.pheno"
# covarsfile<-args[5]
