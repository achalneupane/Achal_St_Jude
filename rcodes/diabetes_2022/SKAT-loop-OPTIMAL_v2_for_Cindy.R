...
treatments <- c("maxabdrtdose.exposed_more_than_200cGy_YN", # abdominal RT
            ...
            "maxpelvisrtdose.exposed_more_than_200cGy_YN", # pelvis RT
            "maxpelvisrtdose.exposed_500cGy_or_higher_YN",
            "maxpelvisrtdose.exposed_1000cGy_or_higher_YN",
            "maxpelvisrtdose.exposed_1500cGy_or_higher_YN",
            "maxpelvisrtdose.exposed_2000cGy_or_higher_YN",
            "abd_OR_pelvis_exposed_more_than_200cGY_YN", # abdomen or pelvis RT
            "abd_OR_pelvis.exposed_500cGy_or_higher_YN", 
            "abd_OR_pelvis.exposed_1000cGy_or_higher_YN",
            "abd_OR_pelvis.exposed_1500cGy_or_higher_YN",
            "abd_OR_pelvis.exposed_2000cGy_or_higher_YN",
...
chrALL <- rbind.data.frame(chrALL, chrALL.tmp)
}
...
formula = c("t2d ~ agedx + gender + age_last_visit + BMIadj + maxabdrtdose.exposed_more_than_200cGy_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*maxabdrtdose.exposed_more_than_200cGy_YN", # abdominal RT
            ...
            "t2d ~ agedx + gender + age_last_visit + BMIadj + maxpelvisrtdose.exposed_more_than_200cGy_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*maxpelvisrtdose.exposed_more_than_200cGy_YN", # pelvis RT
            "t2d ~ agedx + gender + age_last_visit + BMIadj + maxpelvisrtdose.exposed_500cGy_or_higher_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*maxpelvisrtdose.exposed_500cGy_or_higher_YN",
            "t2d ~ agedx + gender + age_last_visit + BMIadj + maxpelvisrtdose.exposed_1000cGy_or_higher_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*maxpelvisrtdose.exposed_1000cGy_or_higher_YN",
            "t2d ~ agedx + gender + age_last_visit + BMIadj + maxpelvisrtdose.exposed_1500cGy_or_higher_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*maxpelvisrtdose.exposed_1500cGy_or_higher_YN",
            "t2d ~ agedx + gender + age_last_visit + BMIadj + maxpelvisrtdose.exposed_2000cGy_or_higher_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*maxpelvisrtdose.exposed_2000cGy_or_higher_YN",
            "t2d ~ agedx + gender + age_last_visit + BMIadj + abd_OR_pelvis_exposed_more_than_200cGY_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*abd_OR_pelvis_exposed_more_than_200cGY_YN", # abdomen or pelvis RT
            "t2d ~ agedx + gender + age_last_visit + BMIadj + abd_OR_pelvis.exposed_500cGy_or_higher_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*abd_OR_pelvis.exposed_500cGy_or_higher_YN", 
            "t2d ~ agedx + gender + age_last_visit + BMIadj + abd_OR_pelvis.exposed_1000cGy_or_higher_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*abd_OR_pelvis.exposed_1000cGy_or_higher_YN",
            "t2d ~ agedx + gender + age_last_visit + BMIadj + abd_OR_pelvis.exposed_1500cGy_or_higher_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*abd_OR_pelvis.exposed_1500cGy_or_higher_YN",
            "t2d ~ agedx + gender + age_last_visit + BMIadj + abd_OR_pelvis.exposed_2000cGy_or_higher_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*abd_OR_pelvis.exposed_2000cGy_or_higher_YN",
...
formula = c("ctcae_grad_3_or_higher_YN ~ agedx + gender + age_last_visit + BMIadj + maxabdrtdose.exposed_more_than_200cGy_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*maxabdrtdose.exposed_more_than_200cGy_YN", # abdominal RT
            ...
            "ctcae_grad_3_or_higher_YN ~ agedx + gender + age_last_visit + BMIadj + maxpelvisrtdose.exposed_more_than_200cGy_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*maxpelvisrtdose.exposed_more_than_200cGy_YN", # pelvis RT
            "ctcae_grad_3_or_higher_YN ~ agedx + gender + age_last_visit + BMIadj + maxpelvisrtdose.exposed_500cGy_or_higher_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*maxpelvisrtdose.exposed_500cGy_or_higher_YN",
            "ctcae_grad_3_or_higher_YN ~ agedx + gender + age_last_visit + BMIadj + maxpelvisrtdose.exposed_1000cGy_or_higher_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*maxpelvisrtdose.exposed_1000cGy_or_higher_YN",
            "ctcae_grad_3_or_higher_YN ~ agedx + gender + age_last_visit + BMIadj + maxpelvisrtdose.exposed_1500cGy_or_higher_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*maxpelvisrtdose.exposed_1500cGy_or_higher_YN",
            "ctcae_grad_3_or_higher_YN ~ agedx + gender + age_last_visit + BMIadj + maxpelvisrtdose.exposed_2000cGy_or_higher_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*maxpelvisrtdose.exposed_2000cGy_or_higher_YN",
            "ctcae_grad_3_or_higher_YN ~ agedx + gender + age_last_visit + BMIadj + abd_OR_pelvis_exposed_more_than_200cGY_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*abd_OR_pelvis_exposed_more_than_200cGY_YN", # abdomen or pelvis RT
            "ctcae_grad_3_or_higher_YN ~ agedx + gender + age_last_visit + BMIadj + abd_OR_pelvis.exposed_500cGy_or_higher_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*abd_OR_pelvis.exposed_500cGy_or_higher_YN", 
            "ctcae_grad_3_or_higher_YN ~ agedx + gender + age_last_visit + BMIadj + abd_OR_pelvis.exposed_1000cGy_or_higher_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*abd_OR_pelvis.exposed_1000cGy_or_higher_YN",
            "ctcae_grad_3_or_higher_YN ~ agedx + gender + age_last_visit + BMIadj + abd_OR_pelvis.exposed_1500cGy_or_higher_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*abd_OR_pelvis.exposed_1500cGy_or_higher_YN",
            "ctcae_grad_3_or_higher_YN ~ agedx + gender + age_last_visit + BMIadj + abd_OR_pelvis.exposed_2000cGy_or_higher_YN + PC1 + PC2 + PC3 + PC4 + PC5 + PC6 + PC7 + PC8 + PC9 + PC10 + RV_Burden + RV_Burden*abd_OR_pelvis.exposed_2000cGy_or_higher_YN",
