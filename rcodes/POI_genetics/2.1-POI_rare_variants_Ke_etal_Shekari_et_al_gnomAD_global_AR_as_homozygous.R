...
saveRDS(carriers.clinvar.all, file = "Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/POI_genetics/Ke_Shekari_etal_POI_genetics_carriers_clinvar_gnomad.all_AR_as_homozygous.rds")
saveRDS(carriers.loftee.all, file = "Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/POI_genetics/Ke_Shekari_etal_POI_genetics_carriers_loftee_gnomad.all_AR_as_homozygous.rds")
saveRDS(carriers.snpeff.all, file = "Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/POI_genetics/Ke_Shekari_etal_POI_genetics_carriers_snpeff_gnomad.all_AR_as_homozygous.rds")
