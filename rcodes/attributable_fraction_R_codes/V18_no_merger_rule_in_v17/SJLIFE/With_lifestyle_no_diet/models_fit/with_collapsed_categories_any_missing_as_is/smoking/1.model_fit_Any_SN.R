## find . -type f -exec sed -i '/\$any_lifestyle_missing/s/^/# /' {} \;
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_diet.Any_SNs.V17.Rdata")
