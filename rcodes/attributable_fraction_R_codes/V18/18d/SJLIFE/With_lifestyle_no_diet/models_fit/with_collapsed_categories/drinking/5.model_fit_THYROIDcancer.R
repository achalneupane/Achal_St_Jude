# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_diet.THYROIDcancer.V18d.Rdata")
...
dat_rt$maxneckrtdose.category [!grepl("Unknown", dat_rt$maxneckrtdose.category)] = "None" ## **
...
dat_tx.rt$maxneckrtdose.category [!grepl("Unknown", dat_tx.rt$maxneckrtdose.category)] =
...
## Nullify Treatment
dat_tx.prs.lifestyle$maxneckrtdose.category [!grepl("Unknown", dat_tx.prs.lifestyle$maxneckrtdose.category)] =
