# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_lifestyle.MENINGIOMA.V14-4-3.Rdata")

df <- cbind.data.frame(any_tx_missing= PHENO.ANY_SN$any_tx_missing,MENINGIOMA= PHENO.ANY_SN$MENINGIOMA)
library(dplyr)
