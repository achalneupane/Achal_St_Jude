# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_lifestyle.NMSCs.V14-4-3.Rdata")

df <- cbind.data.frame(any_tx_missing= PHENO.ANY_SN$any_tx_missing,NMSCs= PHENO.ANY_SN$NMSCs)
library(dplyr)
...
fit_all = glm(formula = NMSCs ~ BASALcell_PRS.tertile.category + 
