# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.Any_SNs_without_lifestyle.V14.Rdata")

df <- cbind.data.frame(any_tx_missing= PHENO.ANY_SN$any_tx_missing,ANY_SNs= PHENO.ANY_SN$ANY_SNs)
library(dplyr)
