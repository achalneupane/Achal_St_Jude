...
table(PHENO.ANY_SN$Current_smoker_yn)
# No     Yes Unknown 
# 6721    1047      95
# 6721    1047      95 ## New
...
save.image("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.Any_SNs.V20b_without_diet.Rdata")
