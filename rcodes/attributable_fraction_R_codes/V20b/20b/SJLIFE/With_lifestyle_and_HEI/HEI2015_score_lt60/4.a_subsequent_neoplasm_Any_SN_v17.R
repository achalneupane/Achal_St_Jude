...
############################# ** add survey_min
PHENO.ANY_SN <- cbind.data.frame(PHENO.ANY_SN, ALL.LIFESTYLE[match(PHENO.ANY_SN$sjlid, ALL.LIFESTYLE$SJLIFEID),c("survey_min", "Current_smoker_yn", "PhysicalActivity_yn", "RiskyHeavyDrink_yn", "HEI2015_TOTAL_SCORE.lt60.category", "Obese_yn")]) ## **
...
save.image("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_with_diet.Any_SNs.V20b_HEI2015_lt60.Rdata")
