...
tryCatch({
  ...
  write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/SJLIFE_Any_SNs_with_all_lifestyle_no_diet_sensitivity_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
