# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/lancetOncology/6.sjlife_without_diet.THYROIDcancer.V21b.Rdata")
...
length(unique(PHENO.ANY_SN$sjlid))
# 3649
cp <- PHENO.ANY_SN[(PHENO.ANY_SN$Smoker_ever_yn == "Yes"),]
length(unique(cp$sjlid))
######################################
