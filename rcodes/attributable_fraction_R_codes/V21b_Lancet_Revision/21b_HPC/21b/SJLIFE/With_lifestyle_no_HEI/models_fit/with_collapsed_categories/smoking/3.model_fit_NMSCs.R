# load ANY SN data
load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/lancetOncology/6.sjlife_without_diet.NMSCs.V21b.Rdata")
...
af_by_combined.AFR.save = rbind(af_by_combined.AFR.save, af_by_combined.AFR)
  ...
  write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/SJLIFE_NMSCswith_lifestyle_no_diet_smoking_only_sensitivity_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
