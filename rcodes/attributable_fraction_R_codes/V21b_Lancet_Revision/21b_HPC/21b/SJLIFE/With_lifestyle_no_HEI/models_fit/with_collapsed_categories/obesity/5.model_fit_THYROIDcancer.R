...
af_by_combined.AFR.save = rbind(af_by_combined.AFR.save, af_by_combined.AFR)
  ...
  write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/SJLIFE_THYROID_with_lifestyle_no_diet_obesity_only_sensitivity_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
