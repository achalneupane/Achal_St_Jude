...
## Load Phenotype data ##
#########################
# load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/lancetOncology/5_lifestyle_v11.RDATA")
...
sum((ALL.LIFESTYLE$Smoker_ever_yn_agesurvey >= 18|
       ...
       ALL.LIFESTYLE$Obese_yn_agesurvey >= 18), na.rm = T)
# 3692
...
############################# ** add survey_min
PHENO.ANY_SN <- cbind.data.frame(PHENO.ANY_SN, ALL.LIFESTYLE[match(PHENO.ANY_SN$sjlid, ALL.LIFESTYLE$SJLIFEID),c("survey_min", "HEI2015_TOTAL_SCORE", "Smoker_ever_yn", "PhysicalActivity_yn", "RiskyHeavyDrink_yn", "HEALTHY_Diet_yn", "Obese_yn")])
...
save.image("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/lancetOncology/6.sjlife_without_diet.Any_SNs.V21b.Rdata")
