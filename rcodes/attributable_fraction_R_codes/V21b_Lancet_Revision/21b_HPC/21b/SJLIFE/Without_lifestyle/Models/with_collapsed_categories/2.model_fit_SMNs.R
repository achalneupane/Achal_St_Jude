...
#############################################
  ...
  write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/any_SMN_without_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
