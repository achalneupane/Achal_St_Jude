...
dim(merged_data)
## Send this to Qi
saveRDS(merged_data, file = "Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/SJLIFE_complete_data.rds")
...
ANY_SNs$KEY <- paste0(ANY_SNs$sjlid, ":", ANY_SNs$sncount)

table(ANY_SNs$KEY %in% sub.other.any.sn.sjlife$KEY)
ANY_SNs <- ANY_SNs[ANY_SNs$KEY %in% sub.other.any.sn.sjlife$KEY,]
...
## **
# save.image("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_lifestyle.Any_SNs.V20b.Rdata")
