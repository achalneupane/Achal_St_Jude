...
table(SMNs$KEY %in% sub.other.smn.sjlife$KEY)
SMNs <- SMNs[SMNs$KEY %in% sub.other.smn.sjlife$KEY,]
...
# save.image("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_lifestyle.SMNs.V20b.Rdata")
