# load ANY SN data
load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE//lancetOncology/6.sjlife_with_diet.MENINGIOMA.V21b_HEI2015_lt60.Rdata")
...
dat_lifestyle$HEI2015_TOTAL_SCORE.lt60.category = "No"
...
dat_tx.prs.lifestyle$HEI2015_TOTAL_SCORE.lt60.category = "No"
...
af_by_combined.AFR.save = rbind(af_by_combined.AFR.save, af_by_combined.AFR)
  ...
  write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/SJLIFE_MENINGIOMA_with_lifestyle_diet_only_sensitivity_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
