# load ANY SN data
load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE//lancetOncology/6.sjlife_with_diet.BREASTcancer.V21b_HEI2015_lt60.Rdata")
...
write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/SJLIFE_BREAST_with_lifestyle_diet_only_sensitivity_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
