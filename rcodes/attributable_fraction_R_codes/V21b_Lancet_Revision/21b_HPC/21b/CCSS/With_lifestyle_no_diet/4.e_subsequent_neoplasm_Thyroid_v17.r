...
THYROIDcancer$gradeage <- THYROIDcancer$AGE.ANY_SN
...
# 
# 
# miss_THYROID <- calculate_missing_counts(PHENO.ANY_SN)
...
# miss_THYROID <- calculate_missing_percentages(PHENO.ANY_SN)
############################################################
...
save.image("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE//lancetOncology/ccss.THYROIDcancer.V21b_without_diet.Rdata")
