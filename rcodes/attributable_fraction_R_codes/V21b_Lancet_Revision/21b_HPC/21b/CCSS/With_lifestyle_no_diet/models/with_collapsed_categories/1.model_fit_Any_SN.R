# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/lancetOncology/ccss.Any_SNs.V21b_without_diet.Rdata") ## $$
...
table(PHENO.ANY_SN$maxpelvisrtdose.category[PHENO.ANY_SN$event == 0])  ## $$
