# load ANY SN data
load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/lancetOncology/ccss.SARCOMA.V21b_without_diet.Rdata")
...
write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/CCSS_SARCOMA_with_lifestyle_no_HEI_Obesity_only_sensitivity_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
