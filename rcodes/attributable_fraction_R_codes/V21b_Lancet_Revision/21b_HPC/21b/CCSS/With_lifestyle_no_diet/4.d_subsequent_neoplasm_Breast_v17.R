...
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE//lancetOncology/00.CCSS_Genetic_data_P_LP_v17.Rdata")
...
BREASTcancer$gradeage <- BREASTcancer$AGE.ANY_SN
...
PHENO.ANY_SN$dob <- BREASTcancer$dob[match(PHENO.ANY_SN$ccssid, BREASTcancer$ccssid)] ## 2009-02-12
PHENO.ANY_SN$gradedt <- BREASTcancer$gradedt[match(PHENO.ANY_SN$ccssid, BREASTcancer$ccssid)] ## 2009-02-12
###################
...
PHENO.ANY_SN <- PHENO.ANY_SN[!(PHENO.ANY_SN$Smoker_ever_yn == "Unknown" &
...
sum((PHENO.ANY_SN$Smoker_ever_yn_agesurvey >= 18|
...
PHENO.ANY_SN <- PHENO.ANY_SN[which(PHENO.ANY_SN$Smoker_ever_yn_agesurvey >= 18 |
                                     PHENO.ANY_SN$PhysicalActivity_yn_agesurvey >= 18 |
                                     PHENO.ANY_SN$RiskyHeavyDrink_yn_agesurvey >= 18 |
...
test.1 <- PHENO.ANY_SN[c("ccssid", "survey_min", "Smoker_ever_yn_agesurvey", "RiskyHeavyDrink_yn_agesurvey", "Obese_yn_agesurvey", "PhysicalActivity_yn_agesurvey","Smoker_ever_yn", "RiskyHeavyDrink_yn", "Obese_yn", "PhysicalActivity_yn")]

# cc <- PHENO.ANY_SN[, c("SJLIFEID", cols, "survey_min")]
PHENO.ANY_SN$Smoker_ever_yn [which(PHENO.ANY_SN$Smoker_ever_yn_agesurvey != PHENO.ANY_SN$survey_min)] <- "Unknown"
...
# # Columns to check
# columns_to_check <- c("PhysicalActivity_yn", "Smoker_ever_yn", "RiskyHeavyDrink_yn", "Obese_yn")
# # columns_to_check <- c("maxsegrtdose.category", "maxabdrtdose.category", "maxchestrtdose.category", "epitxn_dose_5.category")
# miss_BREAST <- get_missing_combinations(PHENO.ANY_SN, columns_to_check)
# 
# 
# miss_BREAST <- calculate_missing_counts(PHENO.ANY_SN)
...
# miss_BREAST <- calculate_missing_percentages(PHENO.ANY_SN)
############################################################
...
save.image("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE//lancetOncology/ccss.BREASTcancer.V21b_without_diet.Rdata")
