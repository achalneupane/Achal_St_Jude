...
table(ANY_SNs$ccssid %in% sub.other.any.sn.ccss$ccssid)
ANY_SNs <- ANY_SNs[ANY_SNs$ccssid %in% sub.other.any.sn.ccss$ccssid,]
...
ANY_SNs$gradeage <- ANY_SNs$gradedt
...
# save.image("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.Any_SNs_without_lifestyle.V17.Rdata")
# save.image("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.Any_SNs_without_lifestyle.V20b.Rdata")
