...
data$Cohort[is.na(data$Cohort)] <- c("SJLIFE", "CCSS", "SJLIFE", "CCSS", "SJLIFE", "CCSS", "SJLIFE")
...
p
plot_name <- "Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/results/plots/v20b/overall/Overall_treatment_and_PRS_without_lifestyle_radial_plot.tiff"
ggsave(plot_name, p, width = 12, height = 8, dpi = 600, device = "tiff", compression = "lzw")
...
plot_name <- "Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/results/plots/v20b/overall/Overall_Chemotherapy_and_Radiation_without_lifestyle_radial_plot.tiff"
ggsave(plot_name, p, width = 12, height = 8, dpi = 600, device = "tiff", compression = "lzw")
