...
######################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_diet.Any_SNs.V20b.Rdata")
...
ANY_SN.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|PhysicalActivity_ynNo|Current_smoker_ynYes|RiskyHeavyDrink_ynYes|Obese_ynYes|any_lifestyle_missingYes|any_chemo_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
ANY_SN.vars
###################################
## Attributable fraction of SMNs ##
###################################
# load SMN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_diet.SMNs.V20b.Rdata")
...
SMN.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|PhysicalActivity_ynNo|Current_smoker_ynYes|RiskyHeavyDrink_ynYes|Obese_ynYes|any_lifestyle_missingYes|any_chemo_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
SMN.vars
########################################
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_diet.NMSCs.V20b.Rdata")
...
NMSC.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|PhysicalActivity_ynNo|Current_smoker_ynYes|RiskyHeavyDrink_ynYes|Obese_ynYes|any_lifestyle_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
NMSC.vars
################################################
## Attributable fraction of Any Breast cancer ##
################################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_diet.BREASTcancer.V20b.Rdata")
...
BREASTCANCER.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|PhysicalActivity_ynNo|Current_smoker_ynYes|RiskyHeavyDrink_ynYes|Obese_ynYes|any_lifestyle_missingYes|any_chemo_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
BREASTCANCER.vars
##########################################
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_diet.THYROIDcancer.V20b.Rdata")
...
THYROID.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|PhysicalActivity_ynNo|Current_smoker_ynYes|RiskyHeavyDrink_ynYes|Obese_ynYes|any_lifestyle_missingYes|any_chemo_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
THYROID.vars
...
#############################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_diet.MENINGIOMA.V20b.Rdata")
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_diet.SARCOMA.V20b.Rdata")
...
SARCOMA.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose|anthra|epitxn|prs|AFR|EAS|PhysicalActivity_ynNo|Current_smoker_ynYes|RiskyHeavyDrink_ynYes|Obese_ynYes|any_lifestyle_missingYes|any_chemo_missingYes", results$Predictor, ignore.case = T),]
SARCOMA.vars
...
empty_dataframe.ordered <- empty_dataframe[match(c(NA, "AGE_AT_DIAGNOSIS5-9", "AGE_AT_DIAGNOSIS10-14", "AGE_AT_DIAGNOSIS>=15", "genderFemale", 
                            ...
                            NA, "Current_smoker_ynYes",
                            NA, "RiskyHeavyDrink_ynYes",
                            NA, "Obese_ynYes",
                            NA, "any_chemo_missingYes", "any_rt_missingYes", "any_lifestyle_missingYes"), empty_dataframe$Predictor),]
...
######################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.Any_SNs.V20b_without_diet.Rdata")
...
###################################
# load ANY SMN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.SMNs.V20b_without_diet.Rdata")
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.NMSCs.V20b_without_diet.Rdata")
...
################################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.BREASTcancer.V20b_without_diet.Rdata")
...
##########################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.THYROIDcancer.V20b_without_diet.Rdata")
...
#############################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.MENINGIOMA.V20b_without_diet.Rdata")
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.SARCOMA.V20b_without_diet.Rdata")
