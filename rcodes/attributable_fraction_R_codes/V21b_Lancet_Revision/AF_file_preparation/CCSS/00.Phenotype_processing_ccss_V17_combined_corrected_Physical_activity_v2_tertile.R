...
TERT = unname(quantile(PHENO.ANY_SN$PhysicalActivity_yn[PHENO.ANY_SN$PhysicalActivity_yn !=0], c(1/3, 2/3), na.rm = T))
PHENO.ANY_SN$PhysicalActivity_yn <- as.character(cut(PHENO.ANY_SN$PhysicalActivity_yn, 
...
PHENO.ANY_SN$Smoker_ever_yn <- as.character(cut(PHENO.ANY_SN$Smoker_ever_yn,  breaks = c(0, TERT),
...
TERT = unname(quantile(PHENO.ANY_SN$RiskyHeavyDrink_yn[PHENO.ANY_SN$RiskyHeavyDrink_yn !=0], c(1/3, 2/3, 1), na.rm = T))
PHENO.ANY_SN$RiskyHeavyDrink_yn <- as.character(cut(PHENO.ANY_SN$RiskyHeavyDrink_yn,  breaks = c(0, TERT),
                                                labels = c("1st", "2nd", "3rd"),
                                                include.lowest = TRUE))
