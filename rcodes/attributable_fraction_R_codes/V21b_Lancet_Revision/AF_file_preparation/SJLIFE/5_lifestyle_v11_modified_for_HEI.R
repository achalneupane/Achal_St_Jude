...
ALL.LIFESTYLE$RiskyHeavyDrink_yn <- factor(
  ifelse(ALL.LIFESTYLE$RiskyHeavyDrink_yn %in% c(9, 10), "No",
         ifelse(ALL.LIFESTYLE$RiskyHeavyDrink_yn %in% 7:8, "Category_7_8",
                ifelse(ALL.LIFESTYLE$RiskyHeavyDrink_yn %in% 4:6, "Category_4_6",
                       ifelse(ALL.LIFESTYLE$RiskyHeavyDrink_yn %in% 1:3, "Category_1_3", NA)))),
