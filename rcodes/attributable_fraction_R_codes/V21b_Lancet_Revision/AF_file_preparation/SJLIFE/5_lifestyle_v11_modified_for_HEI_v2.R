...
PHENO.ANY_SN.old <- ALL.LIFESTYLE
...
ALL.LIFESTYLE$smoker_former_or_never_yn <- smk_iid_dob_18_uniq$smoker_former_or_never_yn[match(ALL.LIFESTYLE$SJLIFEID, smk_iid_dob_18_uniq$SJLIFEID)]
ALL.LIFESTYLE$smoker_former_or_never_yn_agesurvey <- smk_iid_dob_18_uniq$agesurvey[match(ALL.LIFESTYLE$SJLIFEID, smk_iid_dob_18_uniq$SJLIFEID)]
...
# ALL.LIFESTYLE$Smoker_ever_yn <- smk_iid_dob_18_uniq$smoker_ever_yn[match(ALL.LIFESTYLE$SJLIFEID, smk_iid_dob_18_uniq.2$SJLIFEID)]
...
ALL.LIFESTYLE$Obese_yn <- bmi_iid_dob_18_uniq$BMIadj[match(ALL.LIFESTYLE$SJLIFEID, bmi_iid_dob_18_uniq$sjlid)]
ALL.LIFESTYLE$Obese_yn_agesurvey <- bmi_iid_dob_18_uniq$agebmi[match(ALL.LIFESTYLE$SJLIFEID, bmi_iid_dob_18_uniq$sjlid)]
# ALL.LIFESTYLE$Not_obese_yn[is.na(ALL.LIFESTYLE$Not_obese_yn)] <- "Unknown"
# ALL.LIFESTYLE$Not_obese_yn <- factor(ALL.LIFESTYLE$Not_obese_yn, level = c(1, 0, "Unknown")) 
...
ALL.LIFESTYLE$HEI2015_TOTAL_SCORE.tertile.category [PHENO.ANY_SN$sjlid %in% keep.reference] <- NA

# Calculate the median (excluding NAs)
median_value <- median(ALL.LIFESTYLE$HEI2015_TOTAL_SCORE.tertile.category, na.rm = TRUE)
# Create categorical variable: "Below_Median" and "Above_Median"
ALL.LIFESTYLE$HEI2015_TOTAL_SCORE.tertile.category <- ifelse(ALL.LIFESTYLE$HEI2015_TOTAL_SCORE.tertile.category <= median_value, "1st", "2nd")
# ALL.LIFESTYLE$PhysicalActivity_yn <- factor(ALL.LIFESTYLE$PhysicalActivity_yn, levels = c("1st", "2nd"))
...
table(ALL.LIFESTYLE$HEI2015_TOTAL_SCORE.tertile.category)
ALL.LIFESTYLE$HEI2015_TOTAL_SCORE.tertile.category <- factor(ALL.LIFESTYLE$HEI2015_TOTAL_SCORE.tertile.category, 
                                            levels = c("No", "2nd", "1st", "Unknown"))
...
# Calculate the median (excluding NAs)
median_value <- median(ALL.LIFESTYLE$PhysicalActivity_yn, na.rm = TRUE)
# Create categorical variable: "Below_Median" and "Above_Median"
ALL.LIFESTYLE$PhysicalActivity_yn <- ifelse(ALL.LIFESTYLE$PhysicalActivity_yn <= median_value, "1st", "2nd")
# ALL.LIFESTYLE$PhysicalActivity_yn <- factor(ALL.LIFESTYLE$PhysicalActivity_yn, levels = c("1st", "2nd"))
ALL.LIFESTYLE$PhysicalActivity_yn [ALL.LIFESTYLE$SJLIFEID %in% keep.reference] <- "Yes"

ALL.LIFESTYLE$PhysicalActivity_yn [is.na(ALL.LIFESTYLE$PhysicalActivity_yn)] <- "Unknown"
table(ALL.LIFESTYLE$PhysicalActivity_yn)
ALL.LIFESTYLE$PhysicalActivity_yn <- factor(ALL.LIFESTYLE$PhysicalActivity_yn, 
...
# Calculate the median (excluding NAs)
median_value <- median(ALL.LIFESTYLE$Smoker_ever_yn, na.rm = TRUE)
# Create categorical variable: "Below_Median" and "Above_Median"
ALL.LIFESTYLE$Smoker_ever_yn <- ifelse(ALL.LIFESTYLE$Smoker_ever_yn <= median_value, "1st", "2nd")
table(ALL.LIFESTYLE$Smoker_ever_yn)
...
# levels(ALL.LIFESTYLE$PhysicalActivity_yn) <- c(levels(ALL.LIFESTYLE$PhysicalActivity_yn), "Unknown")
ALL.LIFESTYLE$Smoker_ever_yn [is.na(ALL.LIFESTYLE$Smoker_ever_yn)] <- "Unknown"
table(ALL.LIFESTYLE$Smoker_ever_yn)
ALL.LIFESTYLE$Smoker_ever_yn <- factor(ALL.LIFESTYLE$Smoker_ever_yn, 
...
# Calculate the median (excluding NAs)
median_value <- median(ALL.LIFESTYLE$RiskyHeavyDrink_yn, na.rm = TRUE)
# Create categorical variable: "Below_Median" and "Above_Median"
ALL.LIFESTYLE$RiskyHeavyDrink_yn <- ifelse(ALL.LIFESTYLE$RiskyHeavyDrink_yn <= median_value, "1st", "2nd")
table(ALL.LIFESTYLE$RiskyHeavyDrink_yn)
...
ALL.LIFESTYLE$RiskyHeavyDrink_yn <- factor(ALL.LIFESTYLE$RiskyHeavyDrink_yn, 
                                           levels = c("No", "1st", "2nd", "Unknown"))
...
ALL.LIFESTYLE$Obese_yn <- cut(ALL.LIFESTYLE$Obese_yn,
...
#                               labels = c("No", "Overweight", "Obese"),
#                               right = FALSE)
# 
# ALL.LIFESTYLE$Obese_yn <- factor(ALL.LIFESTYLE$Obese_yn, 
#                                  levels = c("No", "Overweight", "Obese", "Unknown"))
...
save.image("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/lancetOncology/5_lifestyle_v11_modified_for_HEI_tertiles.RDATA")
