...
TERT = unname(quantile(ALL.LIFESTYLE$HEI2015_TOTAL_SCORE.tertile.category[ALL.LIFESTYLE$HEI2015_TOTAL_SCORE.tertile.category !=0], c(1/3, 2/3, 1), na.rm = T))
ALL.LIFESTYLE$HEI2015_TOTAL_SCORE.tertile.category <- as.character(cut(ALL.LIFESTYLE$HEI2015_TOTAL_SCORE.tertile.category,  breaks = c(0, TERT),
...
ALL.LIFESTYLE$PhysicalActivity_yn <- as.character(cut(ALL.LIFESTYLE$PhysicalActivity_yn,  breaks = c(0, TERT),
                                                                       labels = c("3rd", "2nd", "1st"),
                                                                       include.lowest = TRUE))
...
ALL.LIFESTYLE$Smoker_ever_yn <- as.character(cut(ALL.LIFESTYLE$Smoker_ever_yn,  breaks = c(0, TERT),
...
TERT = unname(quantile(ALL.LIFESTYLE$RiskyHeavyDrink_yn[ALL.LIFESTYLE$RiskyHeavyDrink_yn !=0], c(1/3, 2/3, 1), na.rm = T))
ALL.LIFESTYLE$RiskyHeavyDrink_yn <- as.character(cut(ALL.LIFESTYLE$RiskyHeavyDrink_yn,  breaks = c(0, TERT),
                                                 labels = c("1st", "2nd", "3rd"),
                                                 include.lowest = TRUE))
