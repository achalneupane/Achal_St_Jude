...
PHENO.ANY_SN <- SNs_py[c("sjlid", "event", "Pleiotropy_PRSWEB_PRS.tertile.category", "BASALcell_PRS.tertile.category", 
                         ...
                         "any_lifestyle_missing", "any_tx_missing", "any_rt_missing",
                         "PY","evt1", "end")]
...
save.image("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/lancetOncology/6.sjlife_with_diet.NMSCs.V21b_HEI2015_lt60.Rdata")
