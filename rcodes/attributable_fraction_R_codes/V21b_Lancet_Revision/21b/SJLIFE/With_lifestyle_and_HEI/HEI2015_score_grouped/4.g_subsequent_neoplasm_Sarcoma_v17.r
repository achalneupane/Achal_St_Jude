...
PHENO.ANY_SN$gradedt <- SARCOMA$gradedt[match(PHENO.ANY_SN$sjlid, SARCOMA$sjlid)]
...
ALL.LIFESTYLE <- ALL.LIFESTYLE[!(ALL.LIFESTYLE$Smoker_ever_yn == "Unknown" &
                                   ALL.LIFESTYLE$PhysicalActivity_yn == "Unknown" &
                                   ALL.LIFESTYLE$RiskyHeavyDrink_yn == "Unknown" &
                                   ALL.LIFESTYLE$Obese_yn == "Unknown" &
                                   ALL.LIFESTYLE$HEI2015_TOTAL_SCORE.lt60.category == "Unknown"),] ## **

dim(ALL.LIFESTYLE)
# [1] 3692   25

sum((ALL.LIFESTYLE$Smoker_ever_yn_agesurvey >= 18|
       ALL.LIFESTYLE$PhysicalActivity_yn_agesurvey >= 18|
       ALL.LIFESTYLE$RiskyHeavyDrink_yn_agesurvey >= 18|
       ALL.LIFESTYLE$Obese_yn_agesurvey >= 18|
...
ALL.LIFESTYLE <- ALL.LIFESTYLE[which(ALL.LIFESTYLE$Smoker_ever_yn_agesurvey >= 18 |
                                       ALL.LIFESTYLE$PhysicalActivity_yn_agesurvey >= 18 |
                                       ALL.LIFESTYLE$RiskyHeavyDrink_yn_agesurvey >= 18 |
                                       ALL.LIFESTYLE$Obese_yn_agesurvey >= 18|
...
ALL.LIFESTYLE$Smoker_ever_yn [which(ALL.LIFESTYLE$Smoker_ever_yn_agesurvey != ALL.LIFESTYLE$survey_min)] <- "Unknown"
ALL.LIFESTYLE$PhysicalActivity_yn [which(ALL.LIFESTYLE$PhysicalActivity_yn_agesurvey != ALL.LIFESTYLE$survey_min)] <- "Unknown"
ALL.LIFESTYLE$RiskyHeavyDrink_yn [which(ALL.LIFESTYLE$RiskyHeavyDrink_yn_agesurvey != ALL.LIFESTYLE$survey_min)] <- "Unknown"
ALL.LIFESTYLE$Obese_yn [which(ALL.LIFESTYLE$Obese_yn_agesurvey != ALL.LIFESTYLE$survey_min)] <- "Unknown"
...
#############################
PHENO.ANY_SN <- cbind.data.frame(PHENO.ANY_SN, ALL.LIFESTYLE[match(PHENO.ANY_SN$sjlid, ALL.LIFESTYLE$SJLIFEID),c("survey_min", "HEI2015_TOTAL_SCORE", "Smoker_ever_yn", "PhysicalActivity_yn", "RiskyHeavyDrink_yn", "HEALTHY_Diet_yn", "HEI2015_TOTAL_SCORE.lt60.category", "Obese_yn")])


## Add any missing to each lifestyle variable
# PHENO.ANY_SN[c("Smoker_ever_yn", "PhysicalActivity_yn", "RiskyHeavyDrink_yn", "Obese_yn")]
PHENO.ANY_SN$any_lifestyle_missing <- apply(PHENO.ANY_SN[c("Smoker_ever_yn", "PhysicalActivity_yn", "RiskyHeavyDrink_yn", "Obese_yn", "HEI2015_TOTAL_SCORE.lt60.category")], 1, function(x) any("Unknown" %in% x)) ## **
...
## Missing lifestyle
PHENO.ANY_SN$Smoker_ever_yn[PHENO.ANY_SN$Smoker_ever_yn == "Unknown"] <- "No"
PHENO.ANY_SN$Smoker_ever_yn <- droplevels(PHENO.ANY_SN$Smoker_ever_yn)
...
PHENO.ANY_SN$HEI2015_TOTAL_SCORE.lt60.category[PHENO.ANY_SN$HEI2015_TOTAL_SCORE.lt60.category == "Unknown"] <- "No" ## **
PHENO.ANY_SN$HEI2015_TOTAL_SCORE.lt60.category <- droplevels(PHENO.ANY_SN$HEI2015_TOTAL_SCORE.lt60.category) ## **
...
save.image("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/lancetOncology/6.sjlife_with_diet.SARCOMA.V21b_HEI2015_lt60.Rdata")
