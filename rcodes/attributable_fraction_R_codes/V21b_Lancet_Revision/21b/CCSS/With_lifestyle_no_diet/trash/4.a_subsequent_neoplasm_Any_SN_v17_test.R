...
# ALL.LIFESTYLE <- edit_lifestyle.ccss(ALL.LIFESTYLE)
...
save.image("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.Any_SNs.V17_without_diet.Rdata")
