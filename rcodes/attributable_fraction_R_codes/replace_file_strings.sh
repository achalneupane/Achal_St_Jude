...
find ./ -type f| grep V11_with_overlapping| egrep -v "Pheno|Rhistory|Merge_all_admixture" | xargs -I {} sed -i sed 's/\bMavaddat_2019_ER_POS_Breast_PRS.tertile.category +//g' {}