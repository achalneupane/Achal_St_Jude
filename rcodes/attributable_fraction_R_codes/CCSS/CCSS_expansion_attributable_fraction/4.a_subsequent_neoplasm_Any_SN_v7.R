...
PHENO.ANY_SN$groupdx3
data.frame(table(PHENO.ANY_SN$groupdx3))
...
# 0.28
# 0.28 Without diet
# 0.28 [With HEI 2015 (instead of Diet) and other 4 lifestyle factors]
##################
## P/LP and PRS ##
##################
...
# -0.066
# -0.075 Without diet
# -0.06 [With HEI 2015 (instead of Diet) and other 4 lifestyle factors]
