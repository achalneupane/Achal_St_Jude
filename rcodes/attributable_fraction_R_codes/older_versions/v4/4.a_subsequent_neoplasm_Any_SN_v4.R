...
# In CASES, if age survey is greater than age at diagnosis; NULLIFY the favorable_lifestyle_yn. That information is not useful
ALL.LIFESTYLE$favorable_lifestyle_yn[ALL.LIFESTYLE$CACO == 1 & ALL.LIFESTYLE$agesurvey > ALL.LIFESTYLE$AGE.ANY_SN] <- NA

PHENO.ANY_SN$favorable_lifestyle_yn <- ALL.LIFESTYLE$favorable_lifestyle_yn[match(PHENO.ANY_SN$sjlid, ALL.LIFESTYLE$SJLIFEID)]
