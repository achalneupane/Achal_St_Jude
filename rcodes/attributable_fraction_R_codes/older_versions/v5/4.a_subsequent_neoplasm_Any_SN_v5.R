...
# # 1. 
# # cbind.data.frame(ALL.LIFESTYLE$smoker_ever_yn, ALL.LIFESTYLE$PhysicalActivity_yn, ALL.LIFESTYLE$Not_Obese_yn, ALL.LIFESTYLE$NOT_RiskyHeavyDrink_yn, ALL.LIFESTYLE$HEALTHY_Diet_yn)
# # 2. 
# ALL.LIFESTYLE$favorable_lifestyle.category [rowSums(cbind.data.frame(ALL.LIFESTYLE$smoker_former_or_never_yn, ALL.LIFESTYLE$PhysicalActivity_yn, ALL.LIFESTYLE$Not_Obese_yn, ALL.LIFESTYLE$NOT_RiskyHeavyDrink_yn, ALL.LIFESTYLE$HEALTHY_Diet_yn)) >= 3] <- "favorable"
# ALL.LIFESTYLE$favorable_lifestyle.category [rowSums(cbind.data.frame(ALL.LIFESTYLE$smoker_former_or_never_yn, ALL.LIFESTYLE$PhysicalActivity_yn, ALL.LIFESTYLE$Not_Obese_yn, ALL.LIFESTYLE$NOT_RiskyHeavyDrink_yn, ALL.LIFESTYLE$HEALTHY_Diet_yn)) == 2] <- "intermediate"
# ALL.LIFESTYLE$favorable_lifestyle.category [rowSums(cbind.data.frame(ALL.LIFESTYLE$smoker_former_or_never_yn, ALL.LIFESTYLE$PhysicalActivity_yn, ALL.LIFESTYLE$Not_Obese_yn, ALL.LIFESTYLE$NOT_RiskyHeavyDrink_yn, ALL.LIFESTYLE$HEALTHY_Diet_yn)) <= 1] <- "unfavorable"
# 
