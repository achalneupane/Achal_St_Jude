...
rm(list=ls())
load("Z:/ResearchHome/ClusterHome/aneupane/St_Jude/Achal_St_Jude/rcodes/attributable_fraction_R_codes/V15_piecewise_exponential/codes_from_Qi/Fwd_ CCSS help/STROKE_counting_process_data_to_check_for_Qi.RData")
...
alldata[1:10,]
### if first>1 (i.e, 2 or mroe events, previous event time remained, others are missing)
