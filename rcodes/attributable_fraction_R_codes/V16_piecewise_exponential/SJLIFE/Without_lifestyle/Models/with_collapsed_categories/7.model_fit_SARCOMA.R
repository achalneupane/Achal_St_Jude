# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_lifestyle.SARCOMA.V16.Rdata")
...
## Nullify Treatment
dat_tx.plp.prs.lifestyle$aa_class_dose_5.category = "1st"
