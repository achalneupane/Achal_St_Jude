...
# save.image("00.PHENO.ANY_MENINGIOMA_CCSS_combined_v11-6.Rdata")

load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/00.PHENO.ANY_MENINGIOMA_CCSS_combined_v11-6.Rdata")
...
as.data.frame(t(CROSS_CASES.df %>%
                  cross_cases(MENINGIOMA, list(Current_smoker_yn, PhysicalActivity_yn, RiskyHeavyDrink_yn, Obese_yn))))
