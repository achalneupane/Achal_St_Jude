...
## P/LP Zhaoming, Qin without Zhaoming and PRS
dat_prs = dat_all
dat_prs$SQUAMOUScell_PRS.tertile.category = dat_plp$BASALcell_PRS.tertile.category = "1st"
...
NMSC.af <- setNames(cbind.data.frame(af_by_tx.chemo, af_by_tx.radiation, af_by_plp, af_by_prs, af_by_tx, af_by_plp.prs, af_by_N_no_favorable_lifestyle.category,
