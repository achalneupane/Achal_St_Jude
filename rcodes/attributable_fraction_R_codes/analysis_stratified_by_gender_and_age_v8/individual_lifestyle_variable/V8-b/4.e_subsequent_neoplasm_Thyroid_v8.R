...
dat_tx$maxneckrtdose.category [!grepl("Unknown", dat_tx$maxneckrtdose.category)] = "None"
...
THYROID.af <- setNames(cbind.data.frame(af_by_tx.chemo, af_by_tx.radiation, af_by_plp, af_by_prs, af_by_tx, af_by_plp.prs, af_by_N_no_favorable_lifestyle.category,
