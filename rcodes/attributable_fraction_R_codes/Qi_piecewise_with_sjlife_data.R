...
QIsubneo <- cbind.data.frame(QIsubneo, ethnicity.admixture[match(QIsubneo$sjlid, ethnicity.admixture$INDIVIDUAL), c("EUR", "EAS", "AFR")])



QIsubneo$agedxcat <- factor(QIsubneo$agedxcat)
QIsubneo$sex <- factor(QIsubneo$sex)
QIsubneo$sex <- relevel(QIsubneo$sex, ref = "Male")

QIsubneo$braincat <- factor(QIsubneo$braincat)
QIsubneo$abdcat <- factor(QIsubneo$abdcat)
QIsubneo$chestcat <- factor(QIsubneo$chestcat)
QIsubneo$pelviscat <- factor(QIsubneo$pelviscat)
QIsubneo$neckcat <- factor(QIsubneo$neckcat)

QIsubneo$cat_anthra_jco_dose <- factor(QIsubneo$cat_anthra_jco_dose)
QIsubneo$cat_epitxn_dose <- factor(QIsubneo$cat_epitxn_dose)
QIsubneo$cat_aa_class_dose <- factor(QIsubneo$cat_aa_class_dose)


## Any SN
anysn <- QIsubneo
table(anysn$sndx)
anysn$sndx[anysn$sndx != 0] <- 1 ## all are any SN
...
# 
# 
# QIsubneo.first <- alldata[alldata$first == 1,]
