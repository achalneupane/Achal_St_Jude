...
table(PHENO.ANY_SN$THYROIDcancer) - table(ALL.LIFESTYLE$CACO)
...
as.data.frame(t(CROSS_CASES.df %>%
                  cross_cases(THYROIDcancer, list(Current_smoker_yn, PhysicalActivity_yn, RiskyHeavyDrink_yn, HEALTHY_Diet_yn, Obese_yn))))
...
thyroid.model <- (setNames(cbind.data.frame(estimate, std.error, P.val
