...
SMN.vars <- results[grepl("diagnosis|gender|maxsegrt|abdomen|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs", results$Predictor, ignore.case = T),]
...
NMSC.vars <- results[grepl("diagnosis|gender|maxsegrt|abdomen|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs", results$Predictor, ignore.case = T),]
...
BREASTCANCER.vars <- results[grepl("diagnosis|gender|maxsegrt|abdomen|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs", results$Predictor, ignore.case = T),]
...
THYROID.vars <- results[grepl("diagnosis|gender|maxsegrt|abdomen|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs", results$Predictor, ignore.case = T),]
...
MENINGIOMA.vars <- results[grepl("diagnosis|gender|maxsegrt|abdomen|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs", results$Predictor, ignore.case = T),]
...
dataframes <- list(ANY_SN=ANY_SN.vars, SMN=SMN.vars, NMSC=NMSC.vars, Breast=BREASTCANCER.vars, Thyroid=THYROID.vars, Meningioma=MENINGIOMA.vars, Sarcoma=SARCOMA.vars)
...
empty_dataframe[is.na(empty_dataframe)] <- ""
