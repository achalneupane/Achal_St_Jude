# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_lifestyle.Any_SNs.V19b.Rdata")
...
## P/LP
P.LP <- readRDS("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common//attr_fraction/PHENOTYPE/2_genetic_data_P_LP.rds")
PHENO.ANY_SN$Zhaoming_carriers <- P.LP$Zhaoming_carriers[match(PHENO.ANY_SN$sjlid, P.LP$sjlid)]
PHENO.ANY_SN$Qin_without_Zhaoming_vars_carriers <- P.LP$Qin_without_Zhaoming_vars_carriers[match(PHENO.ANY_SN$sjlid, P.LP$sjlid)]
######################################
