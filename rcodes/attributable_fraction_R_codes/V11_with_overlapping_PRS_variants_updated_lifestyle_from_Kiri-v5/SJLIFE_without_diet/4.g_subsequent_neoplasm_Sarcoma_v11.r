...
ALL.LIFESTYLE <- ALL.LIFESTYLE[!(ALL.LIFESTYLE$smoker_former_or_never_yn == "Unknown" &
                                   ALL.LIFESTYLE$PhysicalActivity_yn == "Unknown" &
                                   ALL.LIFESTYLE$NOT_RiskyHeavyDrink_yn == "Unknown" &
                                   ALL.LIFESTYLE$Not_obese_yn == "Unknown" ),]
