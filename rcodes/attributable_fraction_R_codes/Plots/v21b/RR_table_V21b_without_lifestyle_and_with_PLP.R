...
ANY_SN.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|Zhaoming|Qin|any_chemo_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
ANY_SN.vars
###################################
## Attributable fraction of SMNs ##
###################################
# load SMN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_lifestyle.SMNs.V20b.Rdata")
...
SMN.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|Zhaoming|Qin|any_chemo_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
SMN.vars
########################################
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_lifestyle.NMSCs.V20b.Rdata")
...
NMSC.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|Zhaoming|Qin|any_rt_missingYes", results$Predictor, ignore.case = T),]
NMSC.vars
################################################
## Attributable fraction of Any Breast cancer ##
################################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_lifestyle.BREASTcancer.V20b.Rdata")
...
BREASTCANCER.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|Zhaoming|Qin|any_chemo_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
BREASTCANCER.vars
##########################################
...
THYROID.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|Zhaoming|Qin|any_chemo_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
THYROID.vars
...
#############################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_lifestyle.MENINGIOMA.V20b.Rdata")
...
MENINGIOMA.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|Zhaoming|Qin|any_chemo_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
MENINGIOMA.vars
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_lifestyle.SARCOMA.V20b.Rdata")
...
SARCOMA.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose|anthra|epitxn|prs|AFR|EAS|Zhaoming|Qin|any_chemo_missingYes", results$Predictor, ignore.case = T),]
SARCOMA.vars
...
empty_dataframe.ordered <- empty_dataframe[match(c(NA, "AGE_AT_DIAGNOSIS5-9", "AGE_AT_DIAGNOSIS10-14", "AGE_AT_DIAGNOSIS>=15", "genderFemale", 
                            ...
                            NA, "AFR", "EAS",
                            NA, "Zhaoming_carriersY",
                            NA, "Qin_without_Zhaoming_vars_carriersY",
                            NA, "any_chemo_missingYes", 
                            NA, "any_rt_missingYes"), empty_dataframe$Predictor),]
...
######################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.Any_SNs_without_lifestyle.PLP.V20b.Rdata")
...
###################################
# load SMN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.SMNs_without_lifestyle.PLP.V20b.Rdata")
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.NMSCs_without_lifestyle.PLP.V20b.Rdata")
...
################################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.BREASTcancer_without_lifestyle.PLP.V20b.Rdata")
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.THYROIDcancer_without_lifestyle.PLP.V20b.Rdata")
...
#############################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.MENINGIOMA_without_lifestyle.PLP.V20b.Rdata")
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.SARCOMA_without_lifestyle.PLP.V20b.Rdata")
