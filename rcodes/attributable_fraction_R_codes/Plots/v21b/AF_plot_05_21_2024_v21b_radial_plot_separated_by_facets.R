...
p
plot_name <- "Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/results/plots/v21b/overall/Overall_treatment_and_PRS_without_lifestyle_radial_plot_faceted.tiff"
ggsave(plot_name, p, width = 18, height = 12, dpi = 400, device = "tiff", compression = "lzw")

# plot_name <- "Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/results/plots/v21b/overall/Overall_treatment_and_PRS_without_lifestyle_radial_plot_faceted_SJLIFE.tiff"
# ggsave(plot_name, p_sjlife, width = 12, height = 8, dpi = 600, device = "tiff", compression = "lzw")
# 
# plot_name <- "Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/results/plots/v21b/overall/Overall_treatment_and_PRS_without_lifestyle_radial_plot_faceted_CCSS.tiff"
...
p = p + theme(plot.margin = margin(r = 0, l = 0, t = 0, b = 0, "cm"))
p
plot_name <- "Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/results/plots/v21b/overall/Overall_Chemotherapy_and_Radiation_without_lifestyle_radial_plot_faceted.tiff"
ggsave(plot_name, p, width = 18, height = 12, dpi = 500, device = "tiff", compression = "lzw")
