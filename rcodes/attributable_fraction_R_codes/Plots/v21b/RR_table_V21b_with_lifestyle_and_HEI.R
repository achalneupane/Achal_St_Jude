...
######################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_with_diet.Any_SNs.V20b_HEI2015_tertile.Rdata")
...
ANY_SN.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|PhysicalActivity_ynNo|Current_smoker_ynYes|RiskyHeavyDrink_ynYes|Obese_ynYes|HEI2015_TOTAL_SCORE.tertile.category2nd|HEI2015_TOTAL_SCORE.tertile.category1st|any_lifestyle_missingYes|any_chemo_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
ANY_SN.vars
###################################
## Attributable fraction of SMNs ##
###################################
# load SMN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_with_diet.SMNs.V20b_HEI2015_tertile.Rdata")
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_with_diet.NMSCs.V20b_HEI2015_tertile.Rdata")
...
NMSC.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|PhysicalActivity_ynNo|Current_smoker_ynYes|RiskyHeavyDrink_ynYes|Obese_ynYes|HEI2015_TOTAL_SCORE.tertile.category2nd|HEI2015_TOTAL_SCORE.tertile.category1st|any_lifestyle_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
NMSC.vars
################################################
## Attributable fraction of Any Breast cancer ##
################################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_with_diet.BREASTcancer.V20b_HEI2015_tertile.Rdata")
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_with_diet.THYROIDcancer.V20b_HEI2015_tertile.Rdata")
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_with_diet.SARCOMA.V20b_HEI2015_tertile.Rdata")
...
SARCOMA.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose|anthra|epitxn|prs|AFR|EAS|PhysicalActivity_ynNo|Current_smoker_ynYes|RiskyHeavyDrink_ynYes|Obese_ynYes|HEI2015_TOTAL_SCORE.tertile.category2nd|HEI2015_TOTAL_SCORE.tertile.category1st|any_lifestyle_missingYes|any_chemo_missingYes", results$Predictor, ignore.case = T),]
SARCOMA.vars
...
empty_dataframe.ordered <- empty_dataframe[match(c(NA, "AGE_AT_DIAGNOSIS5-9", "AGE_AT_DIAGNOSIS10-14", "AGE_AT_DIAGNOSIS>=15", "genderFemale", 
                            ...
                            NA, "Obese_ynYes",
                            NA, "HEI2015_TOTAL_SCORE.tertile.category2nd", "HEI2015_TOTAL_SCORE.tertile.category1st",
