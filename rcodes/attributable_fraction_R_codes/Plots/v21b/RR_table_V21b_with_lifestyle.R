...
######################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_diet.Any_SNs.v21b.Rdata")
...
fit_all <- glm(formula = event ~ Pleiotropy_PRSWEB_PRS.tertile.category +
                 ...
                 Smoker_ever_yn + PhysicalActivity_yn + RiskyHeavyDrink_yn + Obese_yn +
                 EAS + AFR + 
...
ANY_SN.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|PhysicalActivity_ynNo|Smoker_ever_ynYes|RiskyHeavyDrink_ynYes|Obese_ynYes|any_lifestyle_missingYes|any_chemo_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
ANY_SN.vars
###################################
## Attributable fraction of SMNs ##
###################################
# load SMN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_diet.SMNs.v21b.Rdata")
...
SMN.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|PhysicalActivity_ynNo|Smoker_ever_ynYes|RiskyHeavyDrink_ynYes|Obese_ynYes|any_lifestyle_missingYes|any_chemo_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
SMN.vars
########################################
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_diet.NMSCs.v21b.Rdata")
...
NMSC.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|PhysicalActivity_ynNo|Smoker_ever_ynYes|RiskyHeavyDrink_ynYes|Obese_ynYes|any_lifestyle_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
NMSC.vars
################################################
## Attributable fraction of Any Breast cancer ##
################################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_diet.BREASTcancer.v21b.Rdata")
...
BREASTCANCER.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|PhysicalActivity_ynNo|Smoker_ever_ynYes|RiskyHeavyDrink_ynYes|Obese_ynYes|any_lifestyle_missingYes|any_chemo_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
BREASTCANCER.vars
##########################################
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_diet.THYROIDcancer.v21b.Rdata")
...
THYROID.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|PhysicalActivity_ynNo|Smoker_ever_ynYes|RiskyHeavyDrink_ynYes|Obese_ynYes|any_lifestyle_missingYes|any_chemo_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
THYROID.vars
...
#############################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_diet.MENINGIOMA.v21b.Rdata")
...
MENINGIOMA.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose_5|anthra|epitxn|prs|AFR|EAS|PhysicalActivity_ynNo|Smoker_ever_ynYes|RiskyHeavyDrink_ynYes|Obese_ynYes|any_lifestyle_missingYes|any_chemo_missingYes|any_rt_missingYes", results$Predictor, ignore.case = T),]
MENINGIOMA.vars
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_diet.SARCOMA.v21b.Rdata")
...
SARCOMA.vars <- results[grepl("diagnosis|gender|maxsegrt|maxabdrtdose|pelvis|chest|neck|aa_class_dose|anthra|epitxn|prs|AFR|EAS|PhysicalActivity_ynNo|Smoker_ever_ynYes|RiskyHeavyDrink_ynYes|Obese_ynYes|any_lifestyle_missingYes|any_chemo_missingYes", results$Predictor, ignore.case = T),]
SARCOMA.vars
...
######################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.Any_SNs.v21b_without_diet.Rdata")
...
###################################
# load ANY SMN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.SMNs.v21b_without_diet.Rdata")
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.NMSCs.v21b_without_diet.Rdata")
...
################################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.BREASTcancer.v21b_without_diet.Rdata")
...
##########################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.THYROIDcancer.v21b_without_diet.Rdata")
...
#############################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.MENINGIOMA.v21b_without_diet.Rdata")
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.SARCOMA.v21b_without_diet.Rdata")
