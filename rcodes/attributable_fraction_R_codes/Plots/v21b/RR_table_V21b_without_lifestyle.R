...
# load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/testbreastcancer.Rdata")
# ## Check with Zhaoming's
# df <- read.table("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/sjlife_1/preQC/SJLIFEWGS_3006_vcfid_to_sjlid.linkfile", sep = " ", header = F)
# PHENO.ANY_SN <- PHENO.ANY_SN[PHENO.ANY_SN$sjlid %in% df$V2,]
# PHENO.ANY_SN = PHENO.ANY_SN[PHENO.ANY_SN$EUR > 0.8,]
## "SJL1725608" "SJL1764407" are now cases and that make it insignificant association for PRS
...
######################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.Any_SNs_without_lifestyle.V20b.Rdata")
...
###################################
# load ANY SMN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.SMNs_without_lifestyle.V20b.Rdata")
...
################################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.BREASTcancer_without_lifestyle.V20b.Rdata")
...
##########################################
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.THYROIDcancer_without_lifestyle.V20b.Rdata")
...
# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.SARCOMA_without_lifestyle.V20b.Rdata")
