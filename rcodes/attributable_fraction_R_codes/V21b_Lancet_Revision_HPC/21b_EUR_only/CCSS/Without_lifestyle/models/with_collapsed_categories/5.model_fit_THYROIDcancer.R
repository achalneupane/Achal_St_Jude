# load ANY SN data
# load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.THYROIDcancer_without_lifestyle.V18b.Rdata")
...
######################################
dat_all = PHENO.ANY_SN[PHENO.ANY_SN$EUR > 0.8,]
