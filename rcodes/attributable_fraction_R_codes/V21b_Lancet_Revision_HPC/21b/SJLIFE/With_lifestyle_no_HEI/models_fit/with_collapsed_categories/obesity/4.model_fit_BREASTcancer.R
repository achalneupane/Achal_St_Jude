...
write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/SJLIFE_BREASTcancer_with_lifestyle_obesity_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
