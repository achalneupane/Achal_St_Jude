...
ALL.LIFESTYLE$HEI2015_TOTAL_SCORE.tertile.category [which(ALL.LIFESTYLE$HEI2015_TOTAL_SCORE_agesurvey != ALL.LIFESTYLE$survey_min)] <- "Unknown" ## **
...
#############################
PHENO.ANY_SN <- cbind.data.frame(PHENO.ANY_SN, ALL.LIFESTYLE[match(PHENO.ANY_SN$sjlid, ALL.LIFESTYLE$SJLIFEID),c("survey_min", "HEI2015_TOTAL_SCORE", "Smoker_ever_yn", "PhysicalActivity_yn", "RiskyHeavyDrink_yn", "HEI2015_TOTAL_SCORE.tertile.category", "Obese_yn")])


## Add any missing to each lifestyle variable
# PHENO.ANY_SN[c("Smoker_ever_yn", "PhysicalActivity_yn", "RiskyHeavyDrink_yn", "Obese_yn")]
PHENO.ANY_SN$any_lifestyle_missing <- apply(PHENO.ANY_SN[c("Smoker_ever_yn", "PhysicalActivity_yn", "RiskyHeavyDrink_yn", "Obese_yn", "HEI2015_TOTAL_SCORE.tertile.category")], 1, function(x) any("Unknown" %in% x)) ## **
...
PHENO.ANY_SN <- SNs_py[c("sjlid", "event", "Pleiotropy_PRSWEB_PRS.tertile.category", "BASALcell_PRS.tertile.category", 
                         ...
                         "EAS", "AFR", 
                         "Smoker_ever_yn", "PhysicalActivity_yn", "RiskyHeavyDrink_yn", "Obese_yn", "HEI2015_TOTAL_SCORE.tertile.category", 
...
save.image("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_with_diet.SMNs.V21b_HEI2015_tertile.Rdata")
