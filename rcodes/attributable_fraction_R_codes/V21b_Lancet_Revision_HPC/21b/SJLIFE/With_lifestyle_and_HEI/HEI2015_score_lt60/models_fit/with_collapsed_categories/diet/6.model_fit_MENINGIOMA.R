# load ANY SN data
load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_with_diet.MENINGIOMA.V21b_HEI2015_lt60.Rdata")
...
af_by_combined.AFR.save = rbind(af_by_combined.AFR.save, af_by_combined.AFR)
  ...
  write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/SJLIFE_MENINGIOMA_with_lifestyle_HEI_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
