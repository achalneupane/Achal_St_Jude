...
# PHENO.ANY_SN = PHENO.ANY_SN[!PHENO.ANY_SN$sjlid %in% c("SJL1725608", "SJL1764407"),]
...
write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/SJLIFE_BREASTcancer_without_lifestyle_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
