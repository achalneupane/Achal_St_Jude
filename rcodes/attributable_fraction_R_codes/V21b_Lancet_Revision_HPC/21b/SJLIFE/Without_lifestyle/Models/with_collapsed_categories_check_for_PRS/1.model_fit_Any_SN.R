...
## Load P/LP
P.LP <- readRDS("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common//attr_fraction/PHENOTYPE/2_genetic_data_P_LP.rds")
...
## EUR
fit_all = glm(formula = event ~ Pleiotropy_PRSWEB_PRS.Zscore +
                AGE_AT_LAST_CONTACT.cs1 + AGE_AT_LAST_CONTACT.cs2 + AGE_AT_LAST_CONTACT.cs3 + AGE_AT_LAST_CONTACT.cs4 +
                AGE_AT_DIAGNOSIS + gender + 
                maxsegrtdose.category + maxabdrtdose.category + maxchestrtdose.category + epitxn_dose_5.category +
                any_chemo_missing + any_rt_missing,
