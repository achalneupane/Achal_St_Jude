# load ANY SN data
load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_lifestyle.Any_SNs.V20b.Rdata")
...
af_by_plp.zhaoming.Qin.prs.AFR.save = rbind(af_by_plp.zhaoming.Qin.prs.AFR.save, af_by_plp.zhaoming.Qin.prs.AFR)
  ...
  write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/SJLIFE_Any_SNs_without_lifestyle_with_P_LP_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
...
#                 EAS + AFR + 
#                 any_chemo_missing + any_rt_missing +
#                 Pleiotropy_PRSWEB_PRS.tertile.category*EAS +
#                 Pleiotropy_PRSWEB_PRS.tertile.category*AFR,
#               family = "poisson", offset = log(dat_all$PY), data = dat_all)
# 
# summary(fit_all)
# 
