# load ANY SN data
load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_lifestyle.NMSCs.V20b.Rdata")
...
write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/SJLIFE_NMSCs_without_lifestyle_with_P_LP_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
