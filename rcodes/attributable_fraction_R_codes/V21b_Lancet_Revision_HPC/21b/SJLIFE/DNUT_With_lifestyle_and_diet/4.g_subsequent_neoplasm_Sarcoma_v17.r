...
PHENO.ANY_SN$any_lifestyle_missing <- apply(PHENO.ANY_SN[c("Smoker_ever_yn", "PhysicalActivity_yn", "RiskyHeavyDrink_yn", "Obese_yn", "HEALTHY_Diet_yn")], 1, function(x) any("Unknown" %in% x)) ## **
...
PHENO.ANY_SN <- SNs_py[c("sjlid", "event", "Pleiotropy_PRSWEB_PRS.tertile.category", "BASALcell_PRS.tertile.category", 
                         ...
                         "EAS", "AFR", 
                         "Smoker_ever_yn", "PhysicalActivity_yn", "RiskyHeavyDrink_yn", "Obese_yn", "HEALTHY_Diet_yn", 
...
save.image("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_with_diet.SARCOMA.V20b.Rdata")
