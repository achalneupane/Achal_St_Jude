...
load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.SARCOMA_without_lifestyle.PLP.V20b.Rdata")
...
dat_plp = dat_all
dat_plp$Zhaoming_carriers = dat_plp$Qin_without_Zhaoming_vars_carriers = "N"
dat_plp$Sarcoma_Machiela_PRS.tertile.category = "1st"  # **
...
tryCatch({
  ...
  write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/CCSS_SARCOMA_without_lifestyle_with_P_LP_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
