# load ANY SN data
# load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.THYROIDcancer_without_lifestyle.V20b.Rdata")
load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.THYROIDcancer_without_lifestyle.PLP.V20b.Rdata")
...
fit_all = glm(formula = event ~ Zhaoming_carriers + Qin_without_Zhaoming_vars_carriers + 
...
dat_rt$maxneckrtdose.category = "None" ## **
...
dat_tx.rt$maxneckrtdose.category =
...
af_by_plp.zhaoming.Qin = (N_all - N_no_plp.zhaoming.qin) / N_all
# round(af_by_plp.zhaoming.Qin,3)
# 0.028

## Male
N_no_plp.zhaoming.qin = sum(dat_all$pred_no_plp.zhaoming.Qin[dat_all$gender == "Male"], na.rm = TRUE)
af_by_plp.zhaoming.Qin.male = (N_all.male - N_no_plp.zhaoming.qin) / N_all.male
# round(af_by_plp.zhaoming.Qin.male,3)

## Female
N_no_plp.zhaoming.qin = sum(dat_all$pred_no_plp.zhaoming.Qin[dat_all$gender == "Female"], na.rm = TRUE)
af_by_plp.zhaoming.Qin.female = (N_all.female - N_no_plp.zhaoming.qin) / N_all.female
# round(af_by_plp.zhaoming.Qin.female,3)

## < 35
N_no_plp.zhaoming.qin = sum(dat_all$pred_no_plp.zhaoming.Qin[dat_all$AGE_AT_LAST_CONTACT.cs1 < 35], na.rm = TRUE)
af_by_plp.zhaoming.Qin.lt.35 = (N_all.lt.35 - N_no_plp.zhaoming.qin) / N_all.lt.35
# round(af_by_plp.zhaoming.Qin.lt.35,3)


## >= 35
N_no_plp.zhaoming.qin = sum(dat_all$pred_no_plp.zhaoming.Qin[dat_all$AGE_AT_LAST_CONTACT.cs1 >= 35], na.rm = TRUE)
af_by_plp.zhaoming.Qin.gteq.35 = (N_all.gteq.35 - N_no_plp.zhaoming.qin) / N_all.gteq.35
# round(af_by_plp.zhaoming.Qin.gteq.35,3)

## EUR
N_no_plp.zhaoming.qin = sum(dat_all$pred_no_plp.zhaoming.Qin[dat_all$admixture == "EUR"], na.rm = TRUE)
af_by_plp.zhaoming.Qin.EUR = (N_all.EUR - N_no_plp.zhaoming.qin) / N_all.EUR
# af_by_plp.zhaoming.Qin.EUR <- round(af_by_plp.zhaoming.Qin.EUR,3)
af_by_plp.zhaoming.Qin.EUR

## AFR
N_no_plp.zhaoming.qin = sum(dat_all$pred_no_plp.zhaoming.Qin[dat_all$admixture == "AFR"], na.rm = TRUE)
af_by_plp.zhaoming.Qin.AFR = (N_all.AFR - N_no_plp.zhaoming.qin) / N_all.AFR
...
## Nullify Treatment
dat_tx.prs.lifestyle$maxneckrtdose.category =
  dat_tx.prs.lifestyle$epitxn_dose_5.category = "None" ## **

## Nullify Genetics
dat_tx.prs.lifestyle$Zhaoming_carriers = dat_tx.prs.lifestyle$Qin_without_Zhaoming_vars_carriers = "N";
dat_tx.prs.lifestyle$Thyroid_PRS.tertile.category = "1st" ## **
...
af_by_plp.zhaoming.Qin.save = NULL
af_by_plp.zhaoming.Qin.save = rbind(af_by_plp.zhaoming.Qin.save, af_by_plp.zhaoming.Qin)

af_by_plp.zhaoming.Qin.male.save = NULL
af_by_plp.zhaoming.Qin.male.save = rbind(af_by_plp.zhaoming.Qin.male.save, af_by_plp.zhaoming.Qin.male)

af_by_plp.zhaoming.Qin.female.save = NULL
af_by_plp.zhaoming.Qin.female.save = rbind(af_by_plp.zhaoming.Qin.female.save, af_by_plp.zhaoming.Qin.female)

af_by_plp.zhaoming.Qin.lt.35.save = NULL
af_by_plp.zhaoming.Qin.lt.35.save = rbind(af_by_plp.zhaoming.Qin.lt.35.save, af_by_plp.zhaoming.Qin.lt.35)

af_by_plp.zhaoming.Qin.gteq.35.save = NULL
af_by_plp.zhaoming.Qin.gteq.35.save = rbind(af_by_plp.zhaoming.Qin.gteq.35.save, af_by_plp.zhaoming.Qin.gteq.35)

af_by_plp.zhaoming.Qin.EUR.save = NULL
af_by_plp.zhaoming.Qin.EUR.save = rbind(af_by_plp.zhaoming.Qin.EUR.save, af_by_plp.zhaoming.Qin.EUR)

af_by_plp.zhaoming.Qin.AFR.save = NULL
af_by_plp.zhaoming.Qin.AFR.save = rbind(af_by_plp.zhaoming.Qin.AFR.save, af_by_plp.zhaoming.Qin.AFR)

af_by_plp.zhaoming.Qin.prs.save = NULL
af_by_plp.zhaoming.Qin.prs.save = rbind(af_by_plp.zhaoming.Qin.prs.save, af_by_plp.zhaoming.Qin.prs)

af_by_plp.zhaoming.Qin.prs.male.save = NULL
af_by_plp.zhaoming.Qin.prs.male.save = rbind(af_by_plp.zhaoming.Qin.prs.male.save, af_by_plp.zhaoming.Qin.prs.male)

af_by_plp.zhaoming.Qin.prs.female.save = NULL
af_by_plp.zhaoming.Qin.prs.female.save = rbind(af_by_plp.zhaoming.Qin.prs.female.save, af_by_plp.zhaoming.Qin.prs.female)

af_by_plp.zhaoming.Qin.prs.lt.35.save = NULL
af_by_plp.zhaoming.Qin.prs.lt.35.save = rbind(af_by_plp.zhaoming.Qin.prs.lt.35.save, af_by_plp.zhaoming.Qin.prs.lt.35)

af_by_plp.zhaoming.Qin.prs.gteq.35.save = NULL
af_by_plp.zhaoming.Qin.prs.gteq.35.save = rbind(af_by_plp.zhaoming.Qin.prs.gteq.35.save, af_by_plp.zhaoming.Qin.prs.gteq.35)

af_by_plp.zhaoming.Qin.prs.EUR.save = NULL
af_by_plp.zhaoming.Qin.prs.EUR.save = rbind(af_by_plp.zhaoming.Qin.prs.EUR.save, af_by_plp.zhaoming.Qin.prs.EUR)

af_by_plp.zhaoming.Qin.prs.AFR.save = NULL
af_by_plp.zhaoming.Qin.prs.AFR.save = rbind(af_by_plp.zhaoming.Qin.prs.AFR.save, af_by_plp.zhaoming.Qin.prs.AFR)
...
tryCatch({
  for(boot in 1:1000){
    ...
    library(dplyr)
    dat_all <- dat_all2 %>% 
      left_join(sample_ids, by = "ccssid")
  ...
  af_by_plp.zhaoming.Qin = paste0(round(af_by_plp.zhaoming.Qin.save[1,], 3), "_", 
                                  round(quantile(af_by_plp.zhaoming.Qin.save[-1,], probs = c(0.025, 0.975))[1], 3), "-", 
                                  round(quantile(af_by_plp.zhaoming.Qin.save[-1,], probs = c(0.025, 0.975))[2], 3))
  
  af_by_plp.zhaoming.Qin.male = paste0(round(af_by_plp.zhaoming.Qin.male.save[1,], 3), "_", 
                                       round(quantile(af_by_plp.zhaoming.Qin.male.save[-1,], probs = c(0.025, 0.975))[1], 3), "-", 
                                       round(quantile(af_by_plp.zhaoming.Qin.male.save[-1,], probs = c(0.025, 0.975))[2], 3))
  
  af_by_plp.zhaoming.Qin.female = paste0(round(af_by_plp.zhaoming.Qin.female.save[1,], 3), "_", 
                                         round(quantile(af_by_plp.zhaoming.Qin.female.save[-1,], probs = c(0.025, 0.975))[1], 3), "-", 
                                         round(quantile(af_by_plp.zhaoming.Qin.female.save[-1,], probs = c(0.025, 0.975))[2], 3))
  
  af_by_plp.zhaoming.Qin.lt.35 = paste0(round(af_by_plp.zhaoming.Qin.lt.35.save[1,], 3), "_", 
                                        round(quantile(af_by_plp.zhaoming.Qin.lt.35.save[-1,], probs = c(0.025, 0.975))[1], 3), "-", 
                                        round(quantile(af_by_plp.zhaoming.Qin.lt.35.save[-1,], probs = c(0.025, 0.975))[2], 3))
  
  af_by_plp.zhaoming.Qin.gteq.35 = paste0(round(af_by_plp.zhaoming.Qin.gteq.35.save[1,], 3), "_", 
                                          round(quantile(af_by_plp.zhaoming.Qin.gteq.35.save[-1,], probs = c(0.025, 0.975))[1], 3), "-", 
                                          round(quantile(af_by_plp.zhaoming.Qin.gteq.35.save[-1,], probs = c(0.025, 0.975))[2], 3))
  
  af_by_plp.zhaoming.Qin.EUR = paste0(round(af_by_plp.zhaoming.Qin.EUR.save[1,], 3), "_", 
                                      round(quantile(af_by_plp.zhaoming.Qin.EUR.save[-1,], probs = c(0.025, 0.975))[1], 3), "-", 
                                      round(quantile(af_by_plp.zhaoming.Qin.EUR.save[-1,], probs = c(0.025, 0.975))[2], 3))
  
  af_by_plp.zhaoming.Qin.AFR = paste0(round(af_by_plp.zhaoming.Qin.AFR.save[1,], 3), "_", 
                                      round(quantile(af_by_plp.zhaoming.Qin.AFR.save[-1,], probs = c(0.025, 0.975))[1], 3), "-", 
                                      round(quantile(af_by_plp.zhaoming.Qin.AFR.save[-1,], probs = c(0.025, 0.975))[2], 3))
  
  af_by_plp.zhaoming.Qin.prs = paste0(round(af_by_plp.zhaoming.Qin.prs.save[1,], 3), "_", 
                                      round(quantile(af_by_plp.zhaoming.Qin.prs.save[-1,], probs = c(0.025, 0.975))[1], 3), "-", 
                                      round(quantile(af_by_plp.zhaoming.Qin.prs.save[-1,], probs = c(0.025, 0.975))[2], 3))
  
  af_by_plp.zhaoming.Qin.prs.male = paste0(round(af_by_plp.zhaoming.Qin.prs.male.save[1,], 3), "_", 
                                           round(quantile(af_by_plp.zhaoming.Qin.prs.male.save[-1,], probs = c(0.025, 0.975))[1], 3), "-", 
                                           round(quantile(af_by_plp.zhaoming.Qin.prs.male.save[-1,], probs = c(0.025, 0.975))[2], 3))
  
  af_by_plp.zhaoming.Qin.prs.female = paste0(round(af_by_plp.zhaoming.Qin.prs.female.save[1,], 3), "_", 
                                             round(quantile(af_by_plp.zhaoming.Qin.prs.female.save[-1,], probs = c(0.025, 0.975))[1], 3), "-", 
                                             round(quantile(af_by_plp.zhaoming.Qin.prs.female.save[-1,], probs = c(0.025, 0.975))[2], 3))
  
  af_by_plp.zhaoming.Qin.prs.lt.35 = paste0(round(af_by_plp.zhaoming.Qin.prs.lt.35.save[1,], 3), "_", 
                                            round(quantile(af_by_plp.zhaoming.Qin.prs.lt.35.save[-1,], probs = c(0.025, 0.975))[1], 3), "-", 
                                            round(quantile(af_by_plp.zhaoming.Qin.prs.lt.35.save[-1,], probs = c(0.025, 0.975))[2], 3))
  
  af_by_plp.zhaoming.Qin.prs.gteq.35 = paste0(round(af_by_plp.zhaoming.Qin.prs.gteq.35.save[1,], 3), "_", 
                                              round(quantile(af_by_plp.zhaoming.Qin.prs.gteq.35.save[-1,], probs = c(0.025, 0.975))[1], 3), "-", 
                                              round(quantile(af_by_plp.zhaoming.Qin.prs.gteq.35.save[-1,], probs = c(0.025, 0.975))[2], 3))
  
  af_by_plp.zhaoming.Qin.prs.EUR = paste0(round(af_by_plp.zhaoming.Qin.prs.EUR.save[1,], 3), "_", 
                                          round(quantile(af_by_plp.zhaoming.Qin.prs.EUR.save[-1,], probs = c(0.025, 0.975))[1], 3), "-", 
                                          round(quantile(af_by_plp.zhaoming.Qin.prs.EUR.save[-1,], probs = c(0.025, 0.975))[2], 3))
  
  af_by_plp.zhaoming.Qin.prs.AFR = paste0(round(af_by_plp.zhaoming.Qin.prs.AFR.save[1,], 3), "_", 
                                          round(quantile(af_by_plp.zhaoming.Qin.prs.AFR.save[-1,], probs = c(0.025, 0.975))[1], 3), "-", 
                                          round(quantile(af_by_plp.zhaoming.Qin.prs.AFR.save[-1,], probs = c(0.025, 0.975))[2], 3))
  ...
  SN.res <- data.frame(
    ...
    Overall = c(af_by_plp.zhaoming.Qin, af_by_rt, af_by_tx, af_by_tx.rt, af_by_prs, af_by_no_favorable_lifestyle.category, af_by_combined, af_by_plp.zhaoming.Qin.prs),
    Female = c(af_by_plp.zhaoming.Qin.female, af_by_rt.female, af_by_tx.female, af_by_tx.rt.female, af_by_prs.female, af_by_no_favorable_lifestyle.category.female, af_by_combined.female, af_by_plp.zhaoming.Qin.prs.female),
    Male = c(af_by_plp.zhaoming.Qin.male, af_by_rt.male, af_by_tx.male, af_by_tx.rt.male, af_by_prs.male, af_by_no_favorable_lifestyle.category.male, af_by_combined.male, af_by_plp.zhaoming.Qin.prs.male),
    age.lt35 = c(af_by_plp.zhaoming.Qin.lt.35, af_by_rt.lt.35, af_by_tx.lt.35, af_by_tx.rt.lt.35, af_by_prs.lt.35, af_by_no_favorable_lifestyle.category.lt.35, af_by_combined.lt.35, af_by_plp.zhaoming.Qin.prs.lt.35),
    age.gteq = c(af_by_plp.zhaoming.Qin.gteq.35, af_by_rt.gteq.35, af_by_tx.gteq.35, af_by_tx.rt.gteq.35, af_by_prs.gteq.35, af_by_no_favorable_lifestyle.category.gteq.35, af_by_combined.gteq.35, af_by_plp.zhaoming.Qin.prs.gteq.35),
    EUR = c(af_by_plp.zhaoming.Qin.EUR, af_by_rt.EUR, af_by_tx.EUR, af_by_tx.rt.EUR, af_by_prs.EUR, af_by_no_favorable_lifestyle.category.EUR, af_by_combined.EUR, af_by_plp.zhaoming.Qin.prs.EUR),
    AFR = c(af_by_plp.zhaoming.Qin.AFR, af_by_rt.AFR, af_by_tx.AFR, af_by_tx.rt.AFR, af_by_prs.AFR, af_by_no_favorable_lifestyle.category.AFR, af_by_combined.AFR, af_by_plp.zhaoming.Qin.prs.AFR)
  )
  
  
  write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/CCSS_THYROIDcancer_without_lifestyle_with_P_LP_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
...
#                 EAS + AFR +
#                 any_chemo_missing + any_rt_missing +
#                 maxneckrtdose.category * Thyroid_PRS.tertile.category +
#                 epitxn_dose_5.category * Thyroid_PRS.tertile.category,
#               family = "poisson", offset = log(dat_all$PY), data = dat_all)
# 
# summary(fit_all)
# 
