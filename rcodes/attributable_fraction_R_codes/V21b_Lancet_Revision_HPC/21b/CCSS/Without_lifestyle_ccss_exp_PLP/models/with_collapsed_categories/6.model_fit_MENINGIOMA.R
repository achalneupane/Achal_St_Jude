# load ANY SN data
# load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.MENINGIOMA_without_lifestyle.V20b.Rdata")
load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.MENINGIOMA_without_lifestyle.PLP.V20b.Rdata")
...
dat_rt$maxsegrtdose.category = "<18" ## **
...
dat_tx.rt$maxsegrtdose.category = "<18"
...
dat_plp = dat_all
dat_plp$Zhaoming_carriers = dat_plp$Qin_without_Zhaoming_vars_carriers = "N"
dat_plp$Meningioma_PRS.tertile.category = "1st"  # **
...
## Nullify Treatment
dat_tx.prs.lifestyle$maxsegrtdose.category = "<18"
...
tryCatch({
  ...
  write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/CCSS_MENINGIOMA_without_lifestyle_with_P_LP_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
