# load ANY SN data
# load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.Any_SNs_without_lifestyle.V20b.Rdata")
load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.Any_SNs_without_lifestyle.PLP.V20b.Rdata")
...
dat_plp = dat_all
dat_plp$Zhaoming_carriers = dat_plp$Qin_without_Zhaoming_vars_carriers = "N"
dat_plp$Pleiotropy_PRSWEB_PRS.tertile.category = "1st"  # **
...
tryCatch({
  for(boot in 1:1000){
    ...
    #        aa=table(sample_ids)
    # table(aa)
    ### with boot=1 as an example, 1651 ccssids were seleted once, there was 4 ids were selected 6 times. For example SJL1264701
    # aa[aa==6]
  ...
  write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/CCSS_Any_SNs_without_lifestyle_with_P_LP_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
