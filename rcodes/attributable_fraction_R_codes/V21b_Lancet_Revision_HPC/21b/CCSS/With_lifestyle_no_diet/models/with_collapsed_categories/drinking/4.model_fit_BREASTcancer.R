# load ANY SN data
load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.BREASTcancer.V21b_without_diet.Rdata")
...
###########################################
  ...
  write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/CCSS_BREASTcancer_with_lifestyle_drinking_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
