# load ANY SN data
load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.THYROIDcancer.V21b_without_diet.Rdata")
...
table(PHENO.ANY_SN$epitxn_dose_5.category[PHENO.ANY_SN$THYROIDcancer == 1])
######################################
...
# dat_lifestyle$Smoker_ever_yn = "No"
...
## Nullify Lifestyle
# dat_tx.prs.lifestyle$Smoker_ever_yn = "No"
...
write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/CCSS_THYROID_with_lifestyle_physical_activity_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
