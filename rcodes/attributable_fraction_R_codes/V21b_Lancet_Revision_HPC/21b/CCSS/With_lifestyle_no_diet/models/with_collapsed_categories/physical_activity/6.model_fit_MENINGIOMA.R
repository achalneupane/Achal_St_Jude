# load ANY SN data
load("/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/ccss.MENINGIOMA.V21b_without_diet.Rdata")
...
write.table(SN.res, file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/attr_fraction/ANALYSIS/confidence_interval/CCSS_MENINGIOMA_with_lifestyle_physical_activity_res_output.txt", sep = "\t", row.names = FALSE, quote = FALSE)
