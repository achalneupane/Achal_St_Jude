# load ANY SN data
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/attr_fraction/PHENOTYPE/6.sjlife_without_lifestyle.BREASTcancer.V16.Rdata")
...
for (i in 1:length(newScores)){
  ...
  updatedFormula <- as.formula(paste("event ~", newScores[i], "+ AGE_AT_LAST_CONTACT.cs1 + AGE_AT_LAST_CONTACT.cs2 + 
