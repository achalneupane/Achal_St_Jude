...
PHENO.ANY_SN$CACO <- PHENO.ANY_SN$SMN

## In CASES, if age survey is greater then age at diagnosis; NULLIFY the favorable_lifestyle.category. That information is not useful
