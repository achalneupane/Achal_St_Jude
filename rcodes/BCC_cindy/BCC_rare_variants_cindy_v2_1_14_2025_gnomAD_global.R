...
# save.image("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/BCC/files_shared_by_cindy/analysis3/BCC_rare_variants_cindy_v2.RData")
###########################################################################################################################
...
###################################
load("Z:/ResearchHome/Groups/sapkogrp/projects/Genomics/common/BCC/files_shared_by_cindy/analysis3/BCC_rare_variants_cindy_v2.RData")
...
save(list = c("carrier_status_unknown.as.AR", "carrier_status_unknown.as.AD"), file = "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/BCC/files_shared_by_cindy/analysis3//CSG172_carrier_updated_for_AR_genes.RData")
