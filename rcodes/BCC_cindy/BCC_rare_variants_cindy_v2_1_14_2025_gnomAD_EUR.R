...
EUR <- admixture$INDIVIDUAL[admixture$EUR > 0.8]
AFR <- admixture$INDIVIDUAL[admixture$AFR > 0.6]
...
# save(list = c("carrier.status"), file = "BCC_carrier_and_PRS_v2.EUR.RData")
...
save(list = c("carrier_status_unknown.as.AR", "carrier_status_unknown.as.AD"), file = "CSG172_carrier_updated_for_AR_genes_with_both_copies_of_PLP.RData")
