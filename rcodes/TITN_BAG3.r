...
## SNP ID should be same as in LD, so keeping the order of alleles accordingly with the maf
...
gwas.dat$maf[is.na(gwas.dat$maf)]  <- 1-gwas.dat$maf_swapped[is.na(gwas.dat$maf)]
