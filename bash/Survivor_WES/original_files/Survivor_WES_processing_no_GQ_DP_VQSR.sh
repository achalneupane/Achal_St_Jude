...
bsub \
        ...
        -n ${THREADS} \
        -R "rusage[mem=8192]" \
        "/research_jude/rgs01_jude/groups/sapkogrp/projects/Genomics/common/Survivor_WES/biallelic2_noVQSR/biallelic_renaming_split3.sh"; \
done;
...
## Analysis version 3 (GQ and DP but no VQSR)
## Applying GQ filter
# <biallelic_renaming_split3.sh>
#!/usr/bin/bash
module load bcftools
module load vcftools/0.1.16
module load tabi
